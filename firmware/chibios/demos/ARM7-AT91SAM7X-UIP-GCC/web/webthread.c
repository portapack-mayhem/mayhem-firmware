...
static const evhandler_t evhndl[] = {FrameReceivedHandler, PeriodicTimerHandler,
																		 ARPTimerHandler};
...
msg_t WebThread(void* p) {
	...
	chEvtAddEvents(EVENT_MASK(
			FRAME_RECEIVED_ID)); /* In case some frames are already buffered */
