...
static const seqop_t LED3_sequence[] = {{BITSET, PAL_PORT_BIT(GPIOD_LED3)},
																				{SLEEP, 800},
...
static const seqop_t LED4_sequence[] = {{BITSET, PAL_PORT_BIT(GPIOD_LED4)},
																				{SLEEP, 600},
...
static const seqop_t LED5_sequence[] = {{BITSET, PAL_PORT_BIT(GPIOD_LED5)},
																				{SLEEP, 400},
...
static const seqop_t LED6_sequence[] = {{BITSET, PAL_PORT_BIT(GPIOD_LED6)},
																				{SLEEP, 200},
