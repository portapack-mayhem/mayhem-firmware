...
static const ADCConversionGroup adcgrpcfg = {
		...
		0,							 /* CR1 */
		ADC_CR2_SWSTART, /* CR2 */
		0, ADC_SMPR2_SMP_AN10(ADC_SAMPLE_48) | ADC_SMPR2_SMP_SENSOR(ADC_SAMPLE_192),
		0, ADC_SQR1_NUM_CH(ADC_GRP1_NUM_CHANNELS), 0, 0, 0,
 ...
 */
static const SPIConfig spicfg = {spicb,
																 /* HW dependent part.*/
																 GPIOB, 12, SPI_CR1_DFF};
...
int main(void) {
	...
	palSetPadMode(
			GPIOB, 12,
			PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST); /* NSS.     */
