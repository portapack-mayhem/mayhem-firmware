 ...
 */
static uint8_t digits[32] = {0x24, 0xAF, 0xE0, 0xA2, 0x2B, 0x32, 0x30, 0xA7,
 ...
 */
static SPIConfig spicfg = {NULL, GPIO0, GPIO0_SPI0SEL,
													 CR0_DSS8BIT | CR0_FRFSPI | CR0_CLOCKRATE(0), 48};
...
static msg_t Thread2(void* arg) {
	...
	while (TRUE) {
		palClearPort(GPIO0, PAL_PORT_BIT(GPIO0_LED3B) | PAL_PORT_BIT(GPIO0_LED3R) |
		...
		chThdSleepMilliseconds(250);
		palClearPort(GPIO1, PAL_PORT_BIT(GPIO0_LED3B) | PAL_PORT_BIT(GPIO0_LED3R) |
														PAL_PORT_BIT(GPIO0_LED3G));
