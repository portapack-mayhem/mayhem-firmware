...
static const seqop_t LED1_sequence[] = {{BITCLEAR, PAL_PORT_BIT(PA_LED1)},
																				{SLEEP, 200},
...
static const seqop_t LED2_sequence[] = {
		{SLEEP, 1000}, {BITCLEAR, PAL_PORT_BIT(PA_LED2)},
		{SLEEP, 200},	 {BITSET, PAL_PORT_BIT(PA_LED2)},
		{SLEEP, 1800}, {GOTO, 1}};

// Flashing sequence for LED3.
static const seqop_t LED3_sequence[] = {{BITCLEAR, PAL_PORT_BIT(PA_LEDUSB)},
																				{SLEEP, 200},
