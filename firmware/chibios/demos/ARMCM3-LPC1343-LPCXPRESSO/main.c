 ...
 */
static SPIConfig spicfg = {NULL, GPIO1, GPIO1_SPI0SEL,
													 CR0_DSS8BIT | CR0_FRFSPI | CR0_CLOCKRATE(0), 72};
...
static msg_t Thread2(void* arg) {
	...
	while (TRUE) {
		palClearPort(GPIO1, PAL_PORT_BIT(GPIO1_LED3B) | PAL_PORT_BIT(GPIO1_LED3R) |
