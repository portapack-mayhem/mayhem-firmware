...
static void bmk1_execute(void) {
	...
	threads[0] =
			chThdCreateStatic(wa[0], WA_SIZE, chThdGetPriority() - 1, thread1, NULL);
...
ROMCONST struct testcase testbmk1 = {"Benchmark, messages #1", NULL, NULL,
																		 bmk1_execute};
...
ROMCONST struct testcase testbmk2 = {"Benchmark, messages #2", NULL, NULL,
																		 bmk2_execute};
...
static void bmk3_execute(void) {
	...
	threads[0] =
			chThdCreateStatic(wa[0], WA_SIZE, chThdGetPriority() + 1, thread1, NULL);
	threads[1] =
			chThdCreateStatic(wa[1], WA_SIZE, chThdGetPriority() - 2, thread2, NULL);
	threads[2] =
			chThdCreateStatic(wa[2], WA_SIZE, chThdGetPriority() - 3, thread2, NULL);
	threads[3] =
			chThdCreateStatic(wa[3], WA_SIZE, chThdGetPriority() - 4, thread2, NULL);
	threads[4] =
			chThdCreateStatic(wa[4], WA_SIZE, chThdGetPriority() - 5, thread2, NULL);
	n = msg_loop_test(threads[0]);
	test_wait_threads();
	test_print("--- Score : ");
	test_printn(n);
...
ROMCONST struct testcase testbmk3 = {"Benchmark, messages #3", NULL, NULL,
																		 bmk3_execute};
...
static void bmk4_execute(void) {
	...
	tp = threads[0] =
			chThdCreateStatic(wa[0], WA_SIZE, chThdGetPriority() + 1, thread4, NULL);
	n = 0;
	test_wait_tick();
	test_start_timer(1000);
	do {
...
ROMCONST struct testcase testbmk4 = {"Benchmark, context switch", NULL, NULL,
																		 bmk4_execute};
...
ROMCONST struct testcase testbmk5 = {"Benchmark, threads, full cycle", NULL,
																		 NULL, bmk5_execute};
...
ROMCONST struct testcase testbmk6 = {"Benchmark, threads, create only", NULL,
																		 NULL, bmk6_execute};
...
static void bmk7_execute(void) {
	...
	threads[0] =
			chThdCreateStatic(wa[0], WA_SIZE, chThdGetPriority() + 5, thread3, NULL);
	threads[1] =
			chThdCreateStatic(wa[1], WA_SIZE, chThdGetPriority() + 4, thread3, NULL);
	threads[2] =
			chThdCreateStatic(wa[2], WA_SIZE, chThdGetPriority() + 3, thread3, NULL);
	threads[3] =
			chThdCreateStatic(wa[3], WA_SIZE, chThdGetPriority() + 2, thread3, NULL);
	threads[4] =
			chThdCreateStatic(wa[4], WA_SIZE, chThdGetPriority() + 1, thread3, NULL);
...
ROMCONST struct testcase testbmk7 = {"Benchmark, mass reschedule, 5 threads",
																		 bmk7_setup, NULL, bmk7_execute};
...
static void bmk8_execute(void) {
	...
	threads[0] = chThdCreateStatic(wa[0], WA_SIZE, chThdGetPriority() - 1,
																 thread8, (void*)&n);
	threads[1] = chThdCreateStatic(wa[1], WA_SIZE, chThdGetPriority() - 1,
																 thread8, (void*)&n);
	threads[2] = chThdCreateStatic(wa[2], WA_SIZE, chThdGetPriority() - 1,
																 thread8, (void*)&n);
	threads[3] = chThdCreateStatic(wa[3], WA_SIZE, chThdGetPriority() - 1,
																 thread8, (void*)&n);
	threads[4] = chThdCreateStatic(wa[4], WA_SIZE, chThdGetPriority() - 1,
																 thread8, (void*)&n);
...
ROMCONST struct testcase testbmk8 = {"Benchmark, round robin context switching",
																		 NULL, NULL, bmk8_execute};
...
ROMCONST struct testcase testbmk9 = {"Benchmark, I/O Queues throughput", NULL,
																		 NULL, bmk9_execute};
#endif /* CH_USE_QUEUES */
...
ROMCONST struct testcase testbmk10 = {"Benchmark, virtual timers set/reset",
																			NULL, NULL, bmk10_execute};
...
ROMCONST struct testcase testbmk11 = {"Benchmark, semaphores wait/signal",
																			bmk11_setup, NULL, bmk11_execute};
...
ROMCONST struct testcase testbmk12 = {"Benchmark, mutexes lock/unlock",
																			bmk12_setup, NULL, bmk12_execute};
#endif
...
static void bmk13_execute(void) {
	test_print("--- System: ");
	test_printn(sizeof(ReadyList) + sizeof(VTList) + PORT_IDLE_THREAD_STACK_SIZE +
...
ROMCONST struct testcase testbmk13 = {"Benchmark, RAM footprint", NULL, NULL,
																			bmk13_execute};
...
ROMCONST struct testcase* ROMCONST patternbmk[] = {
		...
		&testbmk1,	&testbmk2, &testbmk3, &testbmk4,
		&testbmk5,	&testbmk6, &testbmk7, &testbmk8,
#if CH_USE_QUEUES || defined(__DOXYGEN__)
		&testbmk9,
#endif
		&testbmk10,
