...
ROMCONST struct testcase testdyn1 = {"Dynamic APIs, threads creation from heap",
																		 dyn1_setup, NULL, dyn1_execute};
...
ROMCONST struct testcase testdyn2 = {
		"Dynamic APIs, threads creation from memory pool", dyn2_setup, NULL,
		dyn2_execute};
...
ROMCONST struct testcase testdyn3 = {"Dynamic APIs, registry and references",
