...
ROMCONST struct testcase testqueues1 = {"Queues, input queues", queues1_setup,
																				NULL, queues1_execute};
...
static void queues2_execute(void) {
	...
	threads[0] =
			chThdCreateStatic(wa[0], WA_SIZE, chThdGetPriority() + 1, thread2, NULL);
	...
	/* Timeout */
	test_assert(13, chOQPutTimeout(&oq, 0, 10) == Q_TIMEOUT,
							"wrong timeout return");
}

ROMCONST struct testcase testqueues2 = {"Queues, output queues", queues2_setup,
																				NULL, queues2_execute};
#endif /* CH_USE_QUEUES */
