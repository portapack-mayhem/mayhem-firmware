...
static void mbox1_execute(void) {
	...
	test_assert(15, mb1.mb_buffer == mb1.mb_wrptr,
							"write pointer not aligned to base");
	test_assert(16, mb1.mb_buffer == mb1.mb_rdptr,
							"read pointer not aligned to base");
	...
	test_assert_lock(46, mb1.mb_buffer == mb1.mb_wrptr,
									 "write pointer not aligned to base");
	test_assert_lock(47, mb1.mb_buffer == mb1.mb_rdptr,
									 "read pointer not aligned to base");
}

ROMCONST struct testcase testmbox1 = {"Mailboxes, queuing and timeouts",
																			mbox1_setup, NULL, mbox1_execute};
