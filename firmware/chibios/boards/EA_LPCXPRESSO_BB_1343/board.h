 ...
 */
#define VAL_GPIO0DIR PAL_PORT_BIT(GPIO0_OLEDSEL) | PAL_PORT_BIT(GPIO0_LED2)
#define VAL_GPIO0DATA PAL_PORT_BIT(GPIO0_OLEDSEL) | PAL_PORT_BIT(GPIO0_LED2)

/*
 * GPIO 1 initial setup.
 */
#define VAL_GPIO1DIR                                      \
	PAL_PORT_BIT(GPIO1_LED3B) | PAL_PORT_BIT(GPIO1_LED3R) | \
			PAL_PORT_BIT(GPIO1_LED3G) | PAL_PORT_BIT(GPIO1_SPI0SEL)
