 ...
 */
#define VAL_GPIOBCRL                                 \
	(PIN_OUTPUT_PP_50(0) |		/* SmartCard_3/5V.    */ \
...
#define VAL_GPIOBCRH                                                   \
	(PIN_INPUT(8) |															/* CAN_RX.            */ \
	 ...
	 PIN_UNDEFINED(13) | PIN_OUTPUT_PP_50(14) | /* USB disconnect.    */ \
	 PIN_UNDEFINED(15))
 ...
 */
#define VAL_GPIOCCRL                                                           \
	(PIN_UNDEFINED(0) | PIN_UNDEFINED(1) | PIN_UNDEFINED(2) | PIN_UNDEFINED(3) | \
	 PIN_ANALOG(4) |													/* Potentiometer.     */           \
	 PIN_UNDEFINED(5) | PIN_OUTPUT_PP_50(6) | /* SmartCard CMDVCC.  */           \
	 PIN_INPUT(7))														/* SmartCard OFF.     */
#define VAL_GPIOCCRH                                  \
	(PIN_ALTERNATE_PP_50(8) |	 /* SDIO D0.           */ \
...
#define VAL_GPIODCRH                                  \
	(PIN_ALTERNATE_PP_50(8) |	 /* FSMC_D13.          */ \
 ...
 */
#define VAL_GPIOECRL                                 \
	(PIN_ALTERNATE_PP_50(0) | /* FSMC_NBL0.         */ \
...
#define VAL_GPIOFCRH                                                \
	(PIN_OUTPUT_PP_50(8) |									 /* LED3.              */ \
	 PIN_OUTPUT_PP_50(9) |									 /* LED4.              */ \
	 PIN_UNDEFINED(10) | PIN_INPUT_PUD(11) | /* SDCard detect.     */ \
 ...
 */
#define VAL_GPIOGCRL                                 \
	(PIN_ALTERNATE_PP_50(0) | /* FSMC_A10.          */ \
