...
#define VAL_GPIOA_MODER                                                      \
	(PIN_MODE_ALTERNATE(8) | PIN_MODE_ALTERNATE(13) | PIN_MODE_ALTERNATE(14) | \
	 PIN_MODE_ALTERNATE(15))
#define VAL_GPIOA_OTYPER 0x00000000
#define VAL_GPIOA_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOA_PUPDR \
	(PIN_PUDR_FLOATING(13) | PIN_PUDR_FLOATING(14) | PIN_PUDR_FLOATING(15))
 ...
 */
#define VAL_GPIOB_MODER (PIN_MODE_ALTERNATE(3) | PIN_MODE_ALTERNATE(4))
#define VAL_GPIOB_OTYPER 0x00000000
#define VAL_GPIOB_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOB_PUPDR (~(PIN_PUDR_FLOATING(3) | PIN_PUDR_FLOATING(4)))
...
#define VAL_GPIOC_PUPDR \
	(~(PIN_PUDR_PULLUP(11) | PIN_PUDR_FLOATING(14) | PIN_PUDR_FLOATING(15)))
#define VAL_GPIOC_ODR 0xFFFFFFFF
#define VAL_GPIOC_AFRL 0x00000000
#define VAL_GPIOC_AFRH (PIN_AFIO_AF(7, 10) | PIN_AFIO_AF(7, 11))
