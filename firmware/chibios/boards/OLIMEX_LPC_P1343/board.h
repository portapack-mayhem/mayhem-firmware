...
#define VAL_GPIO2DIR                                        \
	PAL_PORT_BIT(GPIO2_SW1) | PAL_PORT_BIT(GPIO2_LED5) |      \
			PAL_PORT_BIT(GPIO2_LED6) | PAL_PORT_BIT(GPIO2_LED7) | \
			PAL_PORT_BIT(GPIO2_LED8)

#define VAL_GPIO2DATA                                   \
	PAL_PORT_BIT(GPIO2_LED5) | PAL_PORT_BIT(GPIO2_LED6) | \
			PAL_PORT_BIT(GPIO2_LED7) | PAL_PORT_BIT(GPIO2_LED8)
...
#define VAL_GPIO3DIR                                    \
	PAL_PORT_BIT(GPIO3_LED1) | PAL_PORT_BIT(GPIO3_LED2) | \
			PAL_PORT_BIT(GPIO3_LED3) | PAL_PORT_BIT(GPIO3_LED4)
