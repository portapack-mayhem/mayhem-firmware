...
#define VAL_GPIOA_MODER                                                      \
	(PIN_MODE_INPUT(GPIOA_BUTTON_WKUP) |                                       \
	 ...
	 PIN_MODE_INPUT(GPIOA_ETH_RMII_MDINT) | PIN_MODE_INPUT(GPIOA_DCMI_HSYNC) | \
	 PIN_MODE_OUTPUT(GPIOA_LCD_SCK) | PIN_MODE_INPUT(GPIOA_DCMI_PIXCLK) |      \
	 PIN_MODE_ALTERNATE(GPIOA_ETH_RMII_CRS_DV) |                               \
	 PIN_MODE_ALTERNATE(GPIOA_MCO1) | PIN_MODE_INPUT(GPIOA_OTG_FS_VBUS) |      \
	 PIN_MODE_INPUT(GPIOA_DCMI_D1) | PIN_MODE_ALTERNATE(GPIOA_OTG_FS_DM) |     \
	 PIN_MODE_ALTERNATE(GPIOA_OTG_FS_DP) | PIN_MODE_ALTERNATE(GPIOA_SWDIO) |   \
	 PIN_MODE_ALTERNATE(GPIOA_SWCLK) | PIN_MODE_ALTERNATE(GPIOA_I2S3_WS))
#define VAL_GPIOA_OTYPER 0x00000000
#define VAL_GPIOA_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOA_PUPDR                                                     \
	(PIN_PUDR_PULLUP(GPIOA_DCMI_HSYNC) | PIN_PUDR_PULLUP(GPIOA_DCMI_PIXCLK) | \
	 PIN_PUDR_PULLDOWN(GPIOA_OTG_FS_VBUS) | PIN_PUDR_PULLUP(GPIOA_DCMI_D1) |  \
...
#define VAL_GPIOA_AFRH                                              \
	(PIN_AFIO_AF(GPIOA_MCO1, 0) | PIN_AFIO_AF(GPIOA_OTG_FS_DM, 10) |  \
	 PIN_AFIO_AF(GPIOA_OTG_FS_DP, 10) | PIN_AFIO_AF(GPIOA_SWDIO, 0) | \
	 PIN_AFIO_AF(GPIOA_SWCLK, 0) | PIN_AFIO_AF(GPIOA_I2S3_WS, 6))
...
#define VAL_GPIOB_MODER                                                      \
	(PIN_MODE_OUTPUT(GPIOB_LCD_BL) | PIN_MODE_OUTPUT(GPIOB_BUZ) |              \
	 PIN_MODE_INPUT(GPIOB_CAM_ENB) | PIN_MODE_ALTERNATE(GPIOB_I2S3_CK) |       \
	 PIN_MODE_INPUT(GPIOB_LCD_MISO) | PIN_MODE_ALTERNATE(GPIOB_I2S3_SD) |      \
	 PIN_MODE_INPUT(GPIOB_DCMI_D5) | PIN_MODE_INPUT(GPIOB_DCMI_VSYNC) |        \
	 PIN_MODE_ALTERNATE(GPIOB_CAN1_RX) | PIN_MODE_ALTERNATE(GPIOB_CAN1_TX) |   \
...
#define VAL_GPIOB_PUPDR                                                 \
	(PIN_PUDR_PULLUP(GPIOB_DCMI_D5) | PIN_PUDR_PULLUP(GPIOB_DCMI_VSYNC) | \
	 PIN_PUDR_PULLDOWN(GPIOB_OTG_HS_VBUS))
#define VAL_GPIOB_ODR 0xFFFFFFFC
#define VAL_GPIOB_AFRL \
	(PIN_AFIO_AF(GPIOB_I2S3_CK, 6) | PIN_AFIO_AF(GPIOB_I2S3_SD, 6))
#define VAL_GPIOB_AFRH                                                        \
	(PIN_AFIO_AF(GPIOB_CAN1_RX, 9) | PIN_AFIO_AF(GPIOB_CAN1_TX, 9) |            \
	 PIN_AFIO_AF(GPIOB_ETH_RMII_TX_EN, 11) | PIN_AFIO_AF(GPIOB_OTG_HS_ID, 12) | \
...
#define VAL_GPIOC_MODER                                                        \
	(PIN_MODE_INPUT(GPIOC_TRIM) | PIN_MODE_ALTERNATE(GPIOC_ETH_RMII_MDC) |       \
	 PIN_MODE_OUTPUT(GPIOC_USB_FS_VBUSON) | PIN_MODE_OUTPUT(GPIOC_LCD_MOSI) |    \
	 PIN_MODE_ALTERNATE(GPIOC_ETH_RMII_RXD0) |                                   \
	 PIN_MODE_ALTERNATE(GPIOC_ETH_RMII_RXD1) |                                   \
	 PIN_MODE_ALTERNATE(GPIOC_DCMI_D0_US6_TX) |                                  \
	 PIN_MODE_ALTERNATE(GPIOC_I2S3_MCK) | PIN_MODE_INPUT(GPIOC_DCMI_D2) |        \
	 PIN_MODE_INPUT(GPIOC_DCMI_D3) | PIN_MODE_ALTERNATE(GPIOC_SPI3_SCK) |        \
	 PIN_MODE_ALTERNATE(GPIOC_SPI3_MISO) | PIN_MODE_ALTERNATE(GPIOC_SPI3_MOSI) | \
	 PIN_MODE_INPUT(GPIOC_SWITCH_TAMPER) | PIN_MODE_INPUT(GPIOC_OSC32_IN) |      \
	 PIN_MODE_INPUT(GPIOC_OSC32_OUT))
#define VAL_GPIOC_OTYPER 0x00000000
#define VAL_GPIOC_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOC_PUPDR \
	(PIN_PUDR_PULLUP(GPIOC_DCMI_D2) | PIN_PUDR_PULLUP(GPIOC_DCMI_D3))
...
#define VAL_GPIOC_AFRL                    \
	(PIN_AFIO_AF(GPIOC_ETH_RMII_MDC, 11) |  \
	 ...
	 PIN_AFIO_AF(GPIOC_DCMI_D0_US6_TX, 8) | PIN_AFIO_AF(GPIOC_I2S3_MCK, 6))
...
#define VAL_GPIOD_MODER                                                        \
	(PIN_MODE_INPUT(GPIOD_USELESS0) | PIN_MODE_INPUT(GPIOD_USELESS1) |           \
	 PIN_MODE_OUTPUT(GPIOD_SPI3_CS) | PIN_MODE_OUTPUT(GPIOD_LCD_RST) |           \
	 PIN_MODE_INPUT(GPIOD_USELESS4) | PIN_MODE_INPUT(GPIOD_USELESS5) |           \
	 PIN_MODE_OUTPUT(GPIOD_LCD_CS) | PIN_MODE_INPUT(GPIOD_USELESS7) |            \
	 PIN_MODE_ALTERNATE(GPIOD_USART3_TX) | PIN_MODE_ALTERNATE(GPIOD_USART3_RX) | \
	 PIN_MODE_INPUT(GPIOD_USELESS10) | PIN_MODE_ALTERNATE(GPIOD_USART3_CTS) |    \
	 PIN_MODE_ALTERNATE(GPIOD_USART3_RTS) | PIN_MODE_INPUT(GPIOD_USB_HS_FAULT) | \
	 PIN_MODE_INPUT(GPIOD_USELESS14) | PIN_MODE_INPUT(GPIOD_USELESS15))
#define VAL_GPIOD_OTYPER PIN_OTYPE_OPENDRAIN(GPIOD_SPI3_CS)
#define VAL_GPIOD_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOD_PUPDR                                                 \
	(PIN_PUDR_PULLUP(GPIOD_USELESS0) | PIN_PUDR_PULLUP(GPIOD_USELESS1) |  \
	 PIN_PUDR_PULLUP(GPIOD_USELESS4) | PIN_PUDR_PULLUP(GPIOD_USELESS5) |  \
	 PIN_PUDR_PULLUP(GPIOD_USELESS7) | PIN_PUDR_PULLUP(GPIOD_USELESS10) | \
	 PIN_PUDR_PULLUP(GPIOD_USELESS14) | PIN_PUDR_PULLUP(GPIOD_USELESS15))
#define VAL_GPIOD_ODR 0xFFFFFFFF
#define VAL_GPIOD_AFRL 0x00000000
#define VAL_GPIOD_AFRH                                                 \
	(PIN_AFIO_AF(GPIOD_USART3_TX, 7) | PIN_AFIO_AF(GPIOD_USART3_RX, 7) | \
	 PIN_AFIO_AF(GPIOD_USART3_CTS, 7) | PIN_AFIO_AF(GPIOD_USART3_RTS, 7))
...
#define VAL_GPIOE_MODER                                                      \
	(PIN_MODE_INPUT(GPIOE_0) | PIN_MODE_INPUT(GPIOE_1) |                       \
	 PIN_MODE_INPUT(GPIOE_TEMP_ALERT) | PIN_MODE_OUTPUT(GPIOE_USB_HS_VBUSON) | \
	 PIN_MODE_INPUT(GPIOE_4) | PIN_MODE_INPUT(GPIOE_5) |                       \
	 PIN_MODE_INPUT(GPIOE_6) | PIN_MODE_INPUT(GPIOE_7) |                       \
	 PIN_MODE_INPUT(GPIOE_8) | PIN_MODE_INPUT(GPIOE_9) |                       \
	 PIN_MODE_INPUT(GPIOE_10) | PIN_MODE_INPUT(GPIOE_11) |                     \
	 PIN_MODE_INPUT(GPIOE_12) | PIN_MODE_INPUT(GPIOE_13) |                     \
	 PIN_MODE_INPUT(GPIOE_14) | PIN_MODE_INPUT(GPIOE_15))
#define VAL_GPIOE_OTYPER 0x00000000
#define VAL_GPIOE_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOE_PUPDR                                    \
	(PIN_PUDR_PULLUP(GPIOE_0) | PIN_PUDR_PULLUP(GPIOE_1) |   \
	 PIN_PUDR_PULLUP(GPIOE_4) | PIN_PUDR_PULLUP(GPIOE_5) |   \
	 PIN_PUDR_PULLUP(GPIOE_6) | PIN_PUDR_PULLUP(GPIOE_7) |   \
	 PIN_PUDR_PULLUP(GPIOE_8) | PIN_PUDR_PULLUP(GPIOE_9) |   \
	 PIN_PUDR_PULLUP(GPIOE_10) | PIN_PUDR_PULLUP(GPIOE_11) | \
	 PIN_PUDR_PULLUP(GPIOE_12) | PIN_PUDR_PULLUP(GPIOE_13) | \
	 PIN_PUDR_PULLUP(GPIOE_14) | PIN_PUDR_PULLUP(GPIOE_15))
...
#define VAL_GPIOF_MODER                                            \
	(PIN_MODE_INPUT(GPIOF_0) | PIN_MODE_INPUT(GPIOF_1) |             \
	 PIN_MODE_INPUT(GPIOF_2) | PIN_MODE_INPUT(GPIOF_3) |             \
	 PIN_MODE_INPUT(GPIOF_4) | PIN_MODE_INPUT(GPIOF_5) |             \
	 PIN_MODE_OUTPUT(GPIOF_STAT1) | PIN_MODE_OUTPUT(GPIOF_STAT2) |   \
	 PIN_MODE_OUTPUT(GPIOF_STAT3) | PIN_MODE_OUTPUT(GPIOF_CAM_PWR) | \
	 PIN_MODE_INPUT(GPIOF_10) | PIN_MODE_OUTPUT(GPIOF_CAM_RS) |      \
	 PIN_MODE_INPUT(GPIOF_12) | PIN_MODE_INPUT(GPIOF_13) |           \
	 PIN_MODE_INPUT(GPIOF_14) | PIN_MODE_INPUT(GPIOF_15))
#define VAL_GPIOF_OTYPER 0x00000000
#define VAL_GPIOF_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOF_PUPDR                                    \
	(PIN_PUDR_PULLUP(GPIOF_0) | PIN_PUDR_PULLUP(GPIOF_1) |   \
	 PIN_PUDR_PULLUP(GPIOF_2) | PIN_PUDR_PULLUP(GPIOF_3) |   \
	 PIN_PUDR_PULLUP(GPIOF_4) | PIN_PUDR_PULLUP(GPIOF_5) |   \
	 PIN_PUDR_PULLUP(GPIOF_10) | PIN_PUDR_PULLUP(GPIOF_12) | \
	 PIN_PUDR_PULLUP(GPIOF_13) | PIN_PUDR_PULLUP(GPIOF_14) | \
...
#define VAL_GPIOG_MODER                                                 \
	(PIN_MODE_INPUT(GPIOG_0) | PIN_MODE_INPUT(GPIOG_1) |                  \
	 PIN_MODE_INPUT(GPIOG_2) | PIN_MODE_INPUT(GPIOG_3) |                  \
	 PIN_MODE_INPUT(GPIOG_4) | PIN_MODE_INPUT(GPIOG_5) |                  \
	 PIN_MODE_INPUT(GPIOG_RIGHT) | PIN_MODE_INPUT(GPIOG_UP) |             \
	 PIN_MODE_INPUT(GPIOG_DOWN) | PIN_MODE_ALTERNATE(GPIOG_USART6_RX) |   \
	 PIN_MODE_INPUT(GPIOG_10) | PIN_MODE_INPUT(GPIOG_LEFT) |              \
	 PIN_MODE_INPUT(GPIOG_12) | PIN_MODE_ALTERNATE(GPIOG_ETH_RMII_TXD0) | \
	 PIN_MODE_ALTERNATE(GPIOG_ETH_RMII_TXD1) | PIN_MODE_INPUT(GPIOG_CENT))
#define VAL_GPIOG_OTYPER 0x00000000
#define VAL_GPIOG_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOG_PUPDR                                  \
	(PIN_PUDR_PULLUP(GPIOG_0) | PIN_PUDR_PULLUP(GPIOG_1) | \
	 PIN_PUDR_PULLUP(GPIOG_2) | PIN_PUDR_PULLUP(GPIOG_3) | \
	 PIN_PUDR_PULLUP(GPIOG_4) | PIN_PUDR_PULLUP(GPIOG_5) | \
	 PIN_PUDR_PULLUP(GPIOG_10) | PIN_PUDR_PULLUP(GPIOG_12))
#define VAL_GPIOG_ODR 0xFFFFFFFF
#define VAL_GPIOG_AFRL 0x00000000
#define VAL_GPIOG_AFRH                                                      \
	(PIN_AFIO_AF(GPIOG_USART6_RX, 8) | PIN_AFIO_AF(GPIOG_ETH_RMII_TXD0, 11) | \
...
#define VAL_GPIOH_MODER                                           \
	(PIN_MODE_INPUT(GPIOH_OSC_IN) | PIN_MODE_INPUT(GPIOH_OSC_OUT) | \
	 PIN_MODE_INPUT(2) | PIN_MODE_INPUT(3) | PIN_MODE_INPUT(4) |    \
	 PIN_MODE_INPUT(5) | PIN_MODE_INPUT(6) | PIN_MODE_INPUT(7) |    \
	 PIN_MODE_INPUT(8) | PIN_MODE_INPUT(9) | PIN_MODE_INPUT(10) |   \
	 PIN_MODE_INPUT(11) | PIN_MODE_INPUT(12) | PIN_MODE_INPUT(13) | \
	 PIN_MODE_INPUT(14) | PIN_MODE_INPUT(15))
#define VAL_GPIOH_OTYPER 0x00000000
#define VAL_GPIOH_OSPEEDR 0xFFFFFFFF
#define VAL_GPIOH_PUPDR                                                 \
	(PIN_PUDR_FLOATING(GPIOH_OSC_IN) | PIN_PUDR_FLOATING(GPIOH_OSC_OUT) | \
	 PIN_PUDR_PULLUP(2) | PIN_PUDR_PULLUP(3) | PIN_PUDR_PULLUP(4) |       \
	 PIN_PUDR_PULLUP(5) | PIN_PUDR_PULLUP(6) | PIN_PUDR_PULLUP(7) |       \
	 PIN_PUDR_PULLUP(8) | PIN_PUDR_PULLUP(9) | PIN_PUDR_PULLUP(10) |      \
	 PIN_PUDR_PULLUP(11) | PIN_PUDR_PULLUP(12) | PIN_PUDR_PULLUP(13) |    \
	 PIN_PUDR_PULLUP(14) | PIN_PUDR_PULLUP(15))
...
#define VAL_GPIOI_PUPDR                                              \
	(PIN_PUDR_PULLUP(0) | PIN_PUDR_PULLUP(1) | PIN_PUDR_PULLUP(2) |    \
	 PIN_PUDR_PULLUP(3) | PIN_PUDR_PULLUP(4) | PIN_PUDR_PULLUP(5) |    \
	 PIN_PUDR_PULLUP(6) | PIN_PUDR_PULLUP(7) | PIN_PUDR_PULLUP(8) |    \
	 PIN_PUDR_PULLUP(9) | PIN_PUDR_PULLUP(10) | PIN_PUDR_PULLUP(11) |  \
	 PIN_PUDR_PULLUP(12) | PIN_PUDR_PULLUP(13) | PIN_PUDR_PULLUP(14) | \
	 PIN_PUDR_PULLUP(15))
