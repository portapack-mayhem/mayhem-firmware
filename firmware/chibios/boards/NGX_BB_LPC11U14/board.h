...
#define LCD_DATA_MASK                                                      \
	PAL_PORT_BIT(LCD_D0) | PAL_PORT_BIT(LCD_D1) | PAL_PORT_BIT(LCD_D2) |     \
			PAL_PORT_BIT(LCD_D3) | PAL_PORT_BIT(LCD_D4) | PAL_PORT_BIT(LCD_D5) | \
			PAL_PORT_BIT(LCD_D6) | PAL_PORT_BIT(LCD_D7)

/*
 * GPIO 0 initial setup.
 */
#define VAL_GPIO0DIR                                                     \
	PAL_PORT_BIT(LCD_ERD) | PAL_PORT_BIT(LCD_RWR) | PAL_PORT_BIT(LCD_RS) | \
			PAL_PORT_BIT(LED_TEST1) | PAL_PORT_BIT(LED_TEST2)

#define VAL_GPIO0DATA                                                       \
	PAL_PORT_BIT(LCD_ERD) | PAL_PORT_BIT(LCD_RWR) | PAL_PORT_BIT(LED_TEST1) | \
 ...
 */
#define VAL_GPIO1DIR                                                    \
	PAL_PORT_BIT(LCD_RST) | PAL_PORT_BIT(LCD_CS) | PAL_PORT_BIT(LCD_BL) | \
			LCD_DATA_MASK
