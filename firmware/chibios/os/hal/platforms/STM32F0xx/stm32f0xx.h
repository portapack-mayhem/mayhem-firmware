...
/* #define STM32F0XX_LD */ /*!< STM32F0xx Low-density devices are STM32F050xx
															and STM32F060xx microcontrollers where the Flash
															memory ranges between 16 and 32 Kbytes */
/* #define STM32F0XX_MD */ /*!< STM32F0xx Medium-density devices are STM32F051xx
															and STM32F061xx microcontrollers where the Flash
															memory ranges between 16 and 64 Kbytes */
#define STM32F030					 /*!< STM32F030 devices are STM32F030xx value line \
															microcontrollers */
#endif
...
#define HSI_VALUE                                                             \
	((uint32_t)8000000) /*!< Value of the Internal High Speed oscillator in Hz. \
...
#define ADC_CFGR1_AWDCH                                                       \
	((uint32_t)0x7C000000) /*!< AWDCH[4:0] bits (Analog watchdog channel select \
														bits) */
...
#define ADC_CFGR1_AWDSGL                                                    \
	((uint32_t)0x00400000) /*!< Enable the watchdog on a single channel or on \
														all channels  */
#define ADC_CFGR1_DISCEN \
	((uint32_t)0x00010000) /*!< Discontinuous mode on regular channels */
...
#define ADC_CFGR1_EXTEN                                                    \
	((uint32_t)0x00000C00) /*!< EXTEN[1:0] bits (External Trigger Conversion \
...
#define ADC_CFGR1_EXTSEL                                                  \
	((uint32_t)0x000001C0) /*!< EXTSEL[2:0] bits (External Event Select for \
														regular group) */
...
#define ADC_CFGR2_JITOFFDIV4 \
	((uint32_t)0x80000000) /*!< Jitter Off when ADC clocked by PCLK div4 */
#define ADC_CFGR2_JITOFFDIV2 \
	((uint32_t)0x40000000) /*!< Jitter Off when ADC clocked by PCLK div2 */

/******************  Bit definition for ADC_SMPR register  ********************/
#define ADC_SMPR1_SMPR \
	((uint32_t)0x00000007) /*!< SMPR[2:0] bits (Sampling time selection) */
...
#define DBGMCU_APB1_FZ_DBG_TIM14_STOP \
	((uint32_t)0x00000100) /*!< TIM14 counter stopped when core is halted */
...
#define DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT                              \
	((uint32_t)0x00200000) /*!< I2C1 SMBUS timeout mode stopped when Core is \
														halted */

/******************  Bit definition for DBGMCU_APB2_FZ register  **************/
#define DBGMCU_APB2_FZ_DBG_TIM1_STOP \
	((uint32_t)0x00000800) /*!< TIM1 counter stopped when core is halted */
#define DBGMCU_APB2_FZ_DBG_TIM15_STOP \
	((uint32_t)0x00010000) /*!< TIM15 counter stopped when core is halted */
#define DBGMCU_APB2_FZ_DBG_TIM16_STOP \
	((uint32_t)0x00020000) /*!< TIM16 counter stopped when core is halted */
#define DBGMCU_APB2_FZ_DBG_TIM17_STOP \
	((uint32_t)0x00040000) /*!< TIM17 counter stopped when core is halted */
...
#define FLASH_FKEY2                                                            \
	((uint32_t)0xCDEF89AB) /*!< Flash program erase key2: used with FLASH_PEKEY1 \
															to unlock the write access to the FPEC. */

#define FLASH_OPTKEY1 ((uint32_t)0x45670123) /*!< Flash option key1 */
#define FLASH_OPTKEY2                                                          \
	((uint32_t)0xCDEF89AB) /*!< Flash option key2: used with FLASH_OPTKEY1 to    \
...
#define FLASH_CR_OBL_LAUNCH \
	((uint32_t)0x00002000) /*!< Option Bytes Loader Launch */
...
#define FLASH_OBR_VDDA_MONITOR \
	((uint32_t)0x00002000) /*!< VDDA power supply supervisor */
...
#define RCC_CFGR_MCO_HSI14 \
	((uint32_t)0x01000000) /*!< HSI14 clock selected as MCO source */
...
#define RCC_CFGR_MCO_PRE                                               \
	((uint32_t)0x70000000) /*!< MCO prescaler (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_1                                                   \
	((uint32_t)0x00000000) /*!< MCO is divided by 1 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_2                                                   \
	((uint32_t)0x10000000) /*!< MCO is divided by 2 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_4                                                   \
	((uint32_t)0x20000000) /*!< MCO is divided by 4 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_8                                                   \
	((uint32_t)0x30000000) /*!< MCO is divided by 8 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_16                                                   \
	((uint32_t)0x40000000) /*!< MCO is divided by 16 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_32                                                   \
	((uint32_t)0x50000000) /*!< MCO is divided by 32 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_64                                                   \
	((uint32_t)0x60000000) /*!< MCO is divided by 64 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/
#define RCC_CFGR_MCO_PRE_128                                                   \
	((uint32_t)0x70000000) /*!< MCO is divided by 128 (only for STM32F0XX_LD and \
														STM32FO30X6 devices)*/

#define RCC_CFGR_PLLNODIV                                                      \
	((uint32_t)0x80000000) /*!< PLL is not divided to MCO (only for STM32F0XX_LD \
														and STM32FO30X6 devices) */
...
#define RCC_CR2_HSI14ON \
	((uint32_t)0x00000001) /*!< Internal High Speed 14MHz clock enable */
#define RCC_CR2_HSI14RDY \
	((uint32_t)0x00000002) /*!< Internal High Speed 14MHz clock ready flag */
#define RCC_CR2_HSI14DIS \
	((uint32_t)0x00000004) /*!< Internal High Speed 14MHz clock disable */
#define RCC_CR2_HSI14TRIM \
	((uint32_t)0x000000F8) /*!< Internal High Speed 14MHz clock trimming */
#define RCC_CR2_HSI14CAL \
	((uint32_t)0x0000FF00) /*!< Internal High Speed 14MHz clock Calibration */
...
#define SYSCFG_CFGR1_I2C_FMP_I2C1                                              \
	((uint32_t)0x00100000) /*!< Enable Fast Mode Plus on PB10, PB11, PF6 and     \
														PF7(only for STM32F0XX_LD and STM32FO30X6 devices) \
													*/
#define SYSCFG_CFGR1_I2C_FMP_PA9                                     \
	((uint32_t)0x00400000) /*!< Enable Fast Mode Plus on PA9 (only for \
														STM32F0XX_LD and STM32FO30X6 devices) */
#define SYSCFG_CFGR1_I2C_FMP_PA10                                    \
	((uint32_t)0x00800000) /*!< Enable Fast Mode Plus on PA10(only for \
														STM32F0XX_LD and STM32FO30X6 devices) */
...
#define TIM14_OR_TI1_RMP \
	((uint16_t)0x0003) /*!<TI1_RMP[1:0] bits (TIM14 Input 4 remap) */
