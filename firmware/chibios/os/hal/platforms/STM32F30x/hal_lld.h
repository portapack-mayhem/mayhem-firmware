...
/* PLL activation conditions.*/
#if (STM32_SW == STM32_SW_PLL) || (STM32_MCOSEL == STM32_MCOSEL_PLLDIV2) || \
		...
		STM32_USB_CLOCK_REQUIRED || defined(__DOXYGEN__)
/**
...
#if (STM32_SW != STM32_SW_PLL) || (STM32_HPRE != STM32_HPRE_DIV1) || \
		(STM32_PPRE2 != STM32_PPRE2_DIV1)
#error \
		"double clock mode cannot be activated for TIM1 under the current settings"
#endif
...
#define STM32_TIM8CLK (STM32_PCLK2 * 2)
		...
		(STM32_PPRE2 != STM32_PPRE2_DIV1)
#error \
		"double clock mode cannot be activated for TIM8 under the current settings"
#endif
