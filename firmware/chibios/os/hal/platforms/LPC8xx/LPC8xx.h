...
typedef struct {
	...
	__IO uint32_t EXTTRACECMD; /*!< (@ 0x400480FC) External trace buffer command
																register  */
	__IO uint32_t
			PIOPORCAP0; /*!< Offset: 0x100 POR captured PIO status 0 (R/ ) */
	uint32_t RESERVED9[12];
	__IO uint32_t IOCONCLKDIV[7]; /*!< (@0x40048134-14C) Peripheral clock x to the
																	 IOCON block for programmable glitch filter */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC8xx I/O configuration
 * Modification date=3/16/2011 Major revision=0 Minor revision=3  (IOCONFIG)
 */

typedef struct { /*!< (@ 0x40044000) IOCONFIG Structure     */
	__IO uint32_t
			PIO0_17; /*!< (@ 0x40044000) I/O configuration for pin PIO0_17 */
	__IO uint32_t
			PIO0_13; /*!< (@ 0x40044004) I/O configuration for pin PIO0_13 */
	__IO uint32_t
			PIO0_12;					/*!< (@ 0x40044008) I/O configuration for pin PIO0_12 */
	...
	__IO uint32_t
			PIO0_11; /*!< (@ 0x4004401C) I/O configuration for pin PIO0_11 */
	__IO uint32_t
			PIO0_10; /*!< (@ 0x40044020) I/O configuration for pin PIO0_10 */
	__IO uint32_t
			PIO0_16; /*!< (@ 0x40044024) I/O configuration for pin PIO0_16 */
	__IO uint32_t
			PIO0_15;					/*!< (@ 0x40044028) I/O configuration for pin PIO0_15 */
	__IO uint32_t PIO0_1; /*!< (@ 0x4004402C) I/O configuration for pin PIO0_1 */
	__IO uint32_t
			Reserved; /*!< (@ 0x40044030) I/O configuration for pin (Reserved) */
	...
	__IO uint32_t
			PIO0_14; /*!< (@ 0x40044048) I/O configuration for pin PIO0_14 */
} LPC_IOCON_TypeDef;
/*@}*/ /* end of group LPC8xx_IOCON */

/**
 * @brief Product name title=UM10462 Chapter title=LPC8xx Flash programming
 * firmware Major revision=0 Minor revision=3  (FLASHCTRL)
 */
typedef struct { /*!< (@ 0x40040000) FLASHCTRL Structure    */
	...
	__IO uint32_t
			FMSSTART; /*!< (@ 0x40040020) Signature start address register */
	__IO uint32_t
			FMSSTOP; /*!< (@ 0x40040024) Signature stop-address register */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC8xx GPIO Modification
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC8xx GPIO Modification
 * date=3/17/2011 Major revision=0 Minor revision=3  (PIN_INT)
 */
...
typedef struct {			/*!< (@ 0xA0004000) PIN_INT Structure */
	...
	__IO uint32_t
			CIENR; /*!< (@ 0xA000400C) Clear Pin Interrupt Enable (Rising) register */
	__IO uint32_t IENF;	 /*!< (@ 0xA0004010) Pin Interrupt Enable Falling Edge /
													Active Level register */
	__IO uint32_t SIENF; /*!< (@ 0xA0004014) Set Pin Interrupt Enable Falling Edge
													/ Active Level register */
	...
	__IO uint32_t PMCTRL; /*!< (@ 0xA0004028) GPIO pattern match interrupt control
													 register          */
...
typedef struct {			/*!< (@ 0x40028000) WKT Structure          */
	...
	uint32_t Reserved[2];
	__IO uint32_t
			COUNT; /*!< (@ 0x4002800C) Alarm/Wakeup TImer counter register */
} LPC_WKT_TypeDef;
...
*/
/**
 * @brief Product name title=LPC8xx MCU Chapter title=USART Modification
 * date=4/18/2012 Major revision=0 Minor revision=9  (USART)
 */
typedef struct {
...
/**
 * @brief Product name title=UM10430 Chapter title=LPC8xx State Configurable
 * Timer (SCT) Modification date=1/18/2011 Major revision=0 Minor revision=7
 * (SCT)
 */
...
typedef struct {
	...
	__IO uint32_t
			OUTPUTDIRCTRL;			/* 0x054 Output counter direction Control Register */
	...
	union {
		__IO uint16_t
				MATCHREL_L[CONFIG_SCT_nRG]; /* 0x280-... Match Reload value L counter */
		__IO uint16_t CAPCTRL_L[CONFIG_SCT_nRG]; /* 0x280-... Capture Control value
																								L counter */
	};
	uint16_t RESERVED7[32 - CONFIG_SCT_nRG]; /* ...-0x2BE reserved */
	union {
		__IO uint16_t
				MATCHREL_H[CONFIG_SCT_nRG]; /* 0x2C0-... Match Reload value H counter */
		__IO uint16_t CAPCTRL_H[CONFIG_SCT_nRG]; /* 0x2C0-... Capture Control value
																								H counter */
	};
