...
/* Processor and Core Peripheral Section */ /* Configuration of the Cortex-M0
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x I2C-bus controller
 * Modification date=3/16/2011 Major revision=0 Minor revision=3  (I2C)
 */
...
typedef struct {				/*!< (@ 0x40000000) I2C Structure          */
	...
	__IO uint32_t
			SCLH; /*!< (@ 0x40000010) SCH Duty Cycle Register High Half Word */
	__IO uint32_t
	...
	union {
		__IO uint32_t
				MASK[4]; /*!< (@ 0x40000030) I2C Slave address mask register */
		struct {
			__IO uint32_t MASK0;
			__IO uint32_t MASK1;
			__IO uint32_t MASK2;
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x Windowed Watchdog
 * Timer (WWDT) Modification date=3/16/2011 Major revision=0 Minor revision=3
 * (WWDT)
 */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x USART Modification
 * date=3/16/2011 Major revision=0 Minor revision=3  (USART)
 */
...
typedef struct { /*!< (@ 0x40008000) USART Structure        */
	...
	union {
		__O uint32_t FCR; /*!< (@ 0x40008008) FIFO Control Register. Controls USART
	...
	__IO uint32_t ICR; /*!< (@ 0x40008024) IrDA Control Register. Enables and
												configures the IrDA (remote control) mode. */
	__IO uint32_t FDR; /*!< (@ 0x40008028) Fractional Divider Register. Generates
												a clock input for the baud rate divider. */
	__IO uint32_t OSR; /*!< (@ 0x4000802C) Oversampling Register. Controls the
												degree of oversampling during each bit time. */
	__IO uint32_t TER; /*!< (@ 0x40008030) Transmit Enable Register. Turns off
												USART transmitter for use with software flow control. */
	__I uint32_t RESERVED0[3];
	__IO uint32_t HDEN; /*!< (@ 0x40008040) Half duplex enable register. */
	__I uint32_t RESERVED1;
	__IO uint32_t
			SCICTRL; /*!< (@ 0x40008048) Smart Card Interface Control register.
									Enables and configures the Smart Card Interface feature. */
	__IO uint32_t
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x 32-bitcounter/timers
 * CT32B0/1 Modification date=3/16/2011 Major revision=0 Minor revision=3
 */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x ADC Modification
 * date=3/16/2011 Major revision=0 Minor revision=3  (ADC)
 */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x Power Management
 * Unit (PMU) Modification date=3/16/2011 Major revision=0 Minor revision=3
 * (PMU)
 */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x Flash programming
 * firmware Modification date=3/17/2011 Major revision=0 Minor revision=3
 * (FLASHCTRL)
 */
...
typedef struct { /*!< (@ 0x4003C000) FLASHCTRL Structure    */
	...
	__IO uint32_t
			FMSSTART;					 /*!< (@ 0x4003C020) Signature start address register */
	...
	__I uint32_t
			FMSTAT; /*!< (@ 0x4003CFE0) Signature generation status register */
	__I uint32_t RESERVED4[1];
	__IO uint32_t FMSTATCLR; /*!< (@ 0x4003CFE8) Signature generation status clear
															register */
} LPC_FLASHCTRL_Type;
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x SSP/SPI Modification
 * date=3/16/2011 Major revision=0 Minor revision=3  (SSP0)
 */

typedef struct {		 /*!< (@ 0x40040000) SSP0 Structure         */
	__IO uint32_t CR0; /*!< (@ 0x40040000) Control Register 0. Selects the serial
												clock rate, bus type, and data size. */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x I/O configuration
 * Modification date=3/16/2011 Major revision=0 Minor revision=3  (IOCONFIG)
 */

typedef struct {							/*!< (@ 0x40044000) IOCONFIG Structure     */
	__IO uint32_t RESET_PIO0_0; /*!< (@ 0x40044000) I/O configuration for pin
																 RESET/PIO0_0 */
	__IO uint32_t PIO0_1;				/*!< (@ 0x40044004) I/O configuration for pin
																 PIO0_1/CLKOUT/CT32B0_MAT2/USB_FTOGGLE */
	__IO uint32_t PIO0_2;				/*!< (@ 0x40044008) I/O configuration for pin
																 PIO0_2/SSEL0/CT16B0_CAP0 */
	__IO uint32_t
			PIO0_3; /*!< (@ 0x4004400C) I/O configuration for pin PIO0_3/USB_VBUS */
	__IO uint32_t
			PIO0_4; /*!< (@ 0x40044010) I/O configuration for pin PIO0_4/SCL */
	__IO uint32_t
			PIO0_5; /*!< (@ 0x40044014) I/O configuration for pin PIO0_5/SDA */
	__IO uint32_t PIO0_6; /*!< (@ 0x40044018) I/O configuration for pin
													 PIO0_6/USB_CONNECT/SCK0 */
	__IO uint32_t
			PIO0_7; /*!< (@ 0x4004401C) I/O configuration for pin PIO0_7/CTS */
	__IO uint32_t PIO0_8;				 /*!< (@ 0x40044020) I/O configuration for pin
																	PIO0_8/MISO0/CT16B0_MAT0 */
	__IO uint32_t PIO0_9;				 /*!< (@ 0x40044024) I/O configuration for pin
																	PIO0_9/MOSI0/CT16B0_MAT1 */
	__IO uint32_t SWCLK_PIO0_10; /*!< (@ 0x40044028) I/O configuration for pin
																	SWCLK/PIO0_10/ SCK0/CT16B0_MAT2 */
	__IO uint32_t TDI_PIO0_11;	 /*!< (@ 0x4004402C) I/O configuration for pin
																	TDI/PIO0_11/AD0/CT32B0_MAT3 */
	__IO uint32_t TMS_PIO0_12;	 /*!< (@ 0x40044030) I/O configuration for pin
																	TMS/PIO0_12/AD1/CT32B1_CAP0 */
	__IO uint32_t TDO_PIO0_13;	 /*!< (@ 0x40044034) I/O configuration for pin
																	TDO/PIO0_13/AD2/CT32B1_MAT0 */
	__IO uint32_t TRST_PIO0_14;	 /*!< (@ 0x40044038) I/O configuration for pin
																	TRST/PIO0_14/AD3/CT32B1_MAT1 */
	__IO uint32_t SWDIO_PIO0_15; /*!< (@ 0x4004403C) I/O configuration for pin
																	SWDIO/PIO0_15/AD4/CT32B1_MAT2 */
	__IO uint32_t PIO0_16;			 /*!< (@ 0x40044040) I/O configuration for pin
																	PIO0_16/AD5/CT32B1_MAT3/ WAKEUP */
	__IO uint32_t PIO0_17;			 /*!< (@ 0x40044044) I/O configuration for pin
																	PIO0_17/RTS/CT32B0_CAP0/SCLK */
	__IO uint32_t PIO0_18;			 /*!< (@ 0x40044048) I/O configuration for pin
																	PIO0_18/RXD/CT32B0_MAT0 */
	__IO uint32_t PIO0_19;			 /*!< (@ 0x4004404C) I/O configuration for pin
																	PIO0_19/TXD/CT32B0_MAT1 */
	__IO uint32_t PIO0_20;			 /*!< (@ 0x40044050) I/O configuration for pin
																	PIO0_20/CT16B1_CAP0 */
	__IO uint32_t PIO0_21;			 /*!< (@ 0x40044054) I/O configuration for pin
																	PIO0_21/CT16B1_MAT0/MOSI1 */
	__IO uint32_t PIO0_22;			 /*!< (@ 0x40044058) I/O configuration for pin
																	PIO0_22/AD6/CT16B1_MAT1/MISO1 */
	__IO uint32_t
			PIO0_23; /*!< (@ 0x4004405C) I/O configuration for pin PIO0_23/AD7 */
	...
	__IO uint32_t PIO1_5; /*!< (@ 0x40044074) I/O configuration for pin
													 PIO1_5/CT32B1_CAP1 */
	...
	__IO uint32_t PIO1_13; /*!< (@ 0x40044094) I/O configuration for pin
														PIO1_13/DTR/CT16B0_MAT0/TXD */
	__IO uint32_t PIO1_14; /*!< (@ 0x40044098) I/O configuration for pin
														PIO1_14/DSR/CT16B0_MAT1/RXD */
	__IO uint32_t PIO1_15; /*!< (@ 0x4004409C) I/O configuration for pin
														PIO1_15/DCD/ CT16B0_MAT2/SCK1 */
	__IO uint32_t PIO1_16; /*!< (@ 0x400440A0) I/O configuration for pin
														PIO1_16/RI/CT16B0_CAP0 */
	__IO uint32_t PIO1_17;
	__IO uint32_t PIO1_18;
	__IO uint32_t PIO1_19; /*!< (@ 0x400440AC) I/O configuration for pin
														PIO1_19/DTR/SSEL1 */
	__IO uint32_t
			PIO1_20; /*!< (@ 0x400440B0) I/O configuration for pin PIO1_20/DSR/SCK1 */
	__IO uint32_t PIO1_21; /*!< (@ 0x400440B4) I/O configuration for pin
														PIO1_21/DCD/MISO1 */
	__IO uint32_t
			PIO1_22; /*!< (@ 0x400440B8) I/O configuration for pin PIO1_22/RI/MOSI1 */
	__IO uint32_t PIO1_23; /*!< (@ 0x400440BC) I/O configuration for pin
														PIO1_23/CT16B1_MAT1/SSEL1 */
	__IO uint32_t PIO1_24; /*!< (@ 0x400440C0) I/O configuration for pin PIO1_24/
														CT32B0_MAT0 */
	__IO uint32_t PIO1_25; /*!< (@ 0x400440C4) I/O configuration for pin
														PIO1_25/CT32B0_MAT1 */
	__IO uint32_t PIO1_26; /*!< (@ 0x400440C8) I/O configuration for pin
														PIO1_26/CT32B0_MAT2/ RXD */
	__IO uint32_t PIO1_27; /*!< (@ 0x400440CC) I/O configuration for pin
														PIO1_27/CT32B0_MAT3/ TXD */
	__IO uint32_t PIO1_28; /*!< (@ 0x400440D0) I/O configuration for pin
														PIO1_28/CT32B0_CAP0/ SCLK */
	__IO uint32_t PIO1_29; /*!< (@ 0x400440D4) I/O configuration for pin
														PIO1_29/SCK0/ CT32B0_CAP1 */
	__IO uint32_t PIO1_30;
	__IO uint32_t
			PIO1_31; /*!< (@ 0x400440DC) I/O configuration for pin PIO1_31 */
} LPC_IOCON_Type;
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x System control block
 * Modification date=3/16/2011 Major revision=0 Minor revision=3  (SYSCON)
 */
...
typedef struct {						 /*!< (@ 0x40048000) SYSCON Structure       */
	...
	__IO uint32_t
			USBPLLCLKUEN; /*!< (@ 0x4004804C) USB PLL clock source update enable */
	...
	__IO uint32_t
			PINTSEL[8]; /*!< (@ 0x40048178) GPIO Pin Interrupt Select register 0 */
	...
	__IO uint32_t STARTERP0; /*!< (@ 0x40048204) Start logic 0 interrupt wake-up
															enable register 0 */
	__I uint32_t RESERVED12[3];
	__IO uint32_t STARTERP1; /*!< (@ 0x40048214) Start logic 1 interrupt wake-up
															enable register 1 */
	__I uint32_t RESERVED13[6];
	__IO uint32_t
			PDSLEEPCFG; /*!< (@ 0x40048230) Power-down states in deep-sleep mode */
	__IO uint32_t PDAWAKECFG; /*!< (@ 0x40048234) Power-down states for wake-up
															 from deep-sleep */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x GPIO Modification
 * date=3/17/2011 Major revision=0 Minor revision=3  (GPIO_PIN_INT)
 */

typedef struct {			/*!< (@ 0x4004C000) GPIO_PIN_INT Structure */
	__IO uint32_t ISEL; /*!< (@ 0x4004C000) Pin Interrupt Mode register */
	__IO uint32_t
			IENR; /*!< (@ 0x4004C004) Pin Interrupt Enable (Rising) register */
	__IO uint32_t
			SIENR; /*!< (@ 0x4004C008) Set Pin Interrupt Enable (Rising) register */
	__IO uint32_t
			CIENR; /*!< (@ 0x4004C00C) Clear Pin Interrupt Enable (Rising) register */
	__IO uint32_t IENF;	 /*!< (@ 0x4004C010) Pin Interrupt Enable Falling Edge /
													Active Level register */
	__IO uint32_t SIENF; /*!< (@ 0x4004C014) Set Pin Interrupt Enable Falling Edge
													/ Active Level register */
	__IO uint32_t CIENF; /*!< (@ 0x4004C018) Clear Pin Interrupt Enable Falling
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x GPIO Modification
 * date=3/17/2011 Major revision=0 Minor revision=3  (GPIO_GROUP_INT0)
 */

typedef struct { /*!< (@ 0x4005C000) GPIO_GROUP_INT0 Structure */
	__IO uint32_t
			CTRL; /*!< (@ 0x4005C000) GPIO grouped interrupt control register */
	__I uint32_t RESERVED0[7];
	__IO uint32_t PORT_POL[2]; /*!< (@ 0x4005C020) GPIO grouped interrupt port 0
																polarity register */
	__I uint32_t RESERVED1[6];
	__IO uint32_t PORT_ENA[2]; /*!< (@ 0x4005C040) GPIO grouped interrupt port 0/1
																enable register */
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x USB2.0device
 * controller Modification date=3/16/2011 Major revision=0 Minor revision=3
 * (USB)
 */

typedef struct { /*!< (@ 0x40080000) USB Structure          */
	__IO uint32_t
			DEVCMDSTAT;			/*!< (@ 0x40080000) USB Device Command/Status register */
	__IO uint32_t INFO; /*!< (@ 0x40080004) USB Info register      */
	__IO uint32_t EPLISTSTART; /*!< (@ 0x40080008) USB EP Command/Status List
																start address */
	__IO uint32_t
			DATABUFSTART;				/*!< (@ 0x4008000C) USB Data buffer start address */
	...
	__IO uint32_t EPBUFCFG; /*!< (@ 0x4008001C) USB Endpoint Buffer Configuration
														 register */
	...
	__IO uint32_t
			INTSETSTAT; /*!< (@ 0x40080028) USB set interrupt status register */
	__IO uint32_t
			INTROUTING; /*!< (@ 0x4008002C) USB interrupt routing register */
	__I uint32_t RESERVED0[1];
...
/**
 * @brief Product name title=UM10462 Chapter title=LPC11U1x GPIO Modification
 * date=3/17/2011 Major revision=0 Minor revision=3  (GPIO_PORT)
 */

typedef struct {
	union {
		struct {
			__IO uint8_t B0[32]; /*!< (@ 0x50000000) Byte pin registers port 0; pins
															PIO0_0 to PIO0_31 */
...
#define LPC_GPIO_GROUP_INT0 \
	((LPC_GPIO_GROUP_INTx_Type*)LPC_GPIO_GROUP_INT0_BASE)
#define LPC_GPIO_GROUP_INT1 \
	((LPC_GPIO_GROUP_INTx_Type*)LPC_GPIO_GROUP_INT1_BASE)
