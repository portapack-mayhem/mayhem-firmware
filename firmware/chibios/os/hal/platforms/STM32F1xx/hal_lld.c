...
void stm32_clock_init(void) {
	...
	RCC->CFGR = STM32_MCOSEL | STM32_USBPRE | STM32_PLLMUL | STM32_PLLXTPRE |
							...
							STM32_HPRE;
#else
	RCC->CFGR = STM32_MCOSEL | STM32_PLLMUL | STM32_PLLXTPRE | STM32_PLLSRC |
...
void stm32_clock_init(void) {
	...
	RCC->CFGR2 = STM32_PLL3MUL | STM32_PLL2MUL | STM32_PREDIV2 | STM32_PREDIV1 |
							 STM32_PREDIV1SRC;
	...
	RCC->CFGR = STM32_MCOSEL | STM32_OTGFSPRE | STM32_PLLMUL | STM32_PLLSRC |
							STM32_ADCPRE | STM32_PPRE2 | STM32_PPRE1 | STM32_HPRE;
#else
	RCC->CFGR = STM32_MCO | STM32_PLLMUL | STM32_PLLSRC | STM32_ADCPRE |
