...
#define STM32_PLLSRC_PREDIV1         \
	(1 << 16) /**< PLL clock source is \
								 PREDIV1.                   */
...
#define STM32_RTCSEL_HSEDIV                \
	(3 << 8) /**< HSE divided by 128 used as \
								RTC clock.                 */
/** @} */
...
#define RTC_Alarm_IRQHandler           \
	VectorE4 /**< RTC alarm through EXTI \
								line.                      */
...
#if STM32_OTG_CLOCK_REQUIRED || (STM32_SW == STM32_SW_PLL) || \
		(STM32_MCOSEL == STM32_MCOSEL_PLLDIV2) || defined(__DOXYGEN__)
/**
...
/* PLL2 activation conditions.*/
		...
		(STM32_MCOSEL == STM32_MCOSEL_PLL2DIV2) || defined(__DOXYGEN__)
/**
...
#if STM32_I2S_CLOCK_REQUIRED || (STM32_MCOSEL == STM32_MCOSEL_PLL3DIV2) || \
		(STM32_MCOSEL == STM32_MCOSEL_PLL3) || defined(__DOXYGEN__)
/**
...
#error \
		"STM32_PLL2CLKIN outside acceptable range (STM32_PLL23IN_MIN...STM32_PLL23IN_MAX)"
#endif
...
#if (STM32_PLL2VCO < STM32_PLL23VCO_MIN) || (STM32_PLL2VCO > STM32_PLL23VCO_MAX)
#error \
		"STM32_PLL2VCO outside acceptable range (STM32_PLL23VCO_MIN...STM32_PLL23VCO_MAX)"
#endif
...
#error \
		"STM32_PLL3CLKIN outside acceptable range (STM32_PLL23IN_MIN...STM32_PLL23IN_MAX)"
#endif
...
#if (STM32_PLL3VCO < STM32_PLL23VCO_MIN) || (STM32_PLL3VCO > STM32_PLL23VCO_MAX)
#error \
		"STM32_PLL3CLKOUT outside acceptable range (STM32_PLL23VCO_MIN...STM32_PLL23VCO_MAX)"
#endif
...
#error \
		"STM32_PLLCLKIN outside acceptable range (STM32_PLL1IN_MIN...STM32_PLL1IN_MAX)"
#endif
...
#error \
		"STM32_PLLVCO outside acceptable range (STM32_PLL1VCO_MIN...STM32_PLL1VCO_MAX)"
#endif
