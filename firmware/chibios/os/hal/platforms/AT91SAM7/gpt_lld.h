...
typedef struct {
	 ...
	 */
	uint8_t clocksource;
#define GPT_CLOCK_MCLK \
	0	 // @< Internal clock. frequency must = MCLK/2, MCLK/8, MCLK/32, MCLK/128 or
		 // MCLK/1024
#define GPT_CLOCK_FREQUENCY \
	1	 // @< Internal clock. interval is ignored. frequency determines rate
...
#define GPT_GATE_TCLK0 \
	1	 // @< Clock on TCLK0 active high signal. If using this on TC0 with
		 // GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_GATE_TCLK1 \
	2	 // @< Clock on TCLK1 active high signal. If using this on TC1 with
		 // GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_GATE_TCLK2 \
	3	 // @< Clock on TCLK2 active high signal. If using this on TC2 with
		 // GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
	uint8_t trigger;
...
#define GPT_TRIGGER_RE_TCLK0 \
	0x11	// @< Start on TCLK0 signal. Rising Edge.  If using this on TC0 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_FE_TCLK0 \
	0x21	// @< Start on TCLK0 signal. Falling Edge. If using this on TC0 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_BE_TCLK0 \
	0x31	// @< Start on TCLK0 signal. Both Edges.   If using this on TC0 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_RE_TCLK1 \
	0x12	// @< Start on TCLK1 signal. Rising Edge.  If using this on TC1 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_FE_TCLK1 \
	0x22	// @< Start on TCLK1 signal. Falling Edge. If using this on TC1 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_BE_TCLK1 \
	0x32	// @< Start on TCLK1 signal. Both Edges.   If using this on TC1 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_RE_TCLK2 \
	0x13	// @< Start on TCLK2 signal. Rising Edge.  If using this on TC2 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_FE_TCLK2 \
	0x23	// @< Start on TCLK2 signal. Falling Edge. If using this on TC2 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
#define GPT_TRIGGER_BE_TCLK2 \
	0x33	// @< Start on TCLK2 signal. Both Edges.   If using this on TC2 with
				// GPT_CLOCK_xx_TIMx, the TIMx output will be used instead.
} GPTConfig;
