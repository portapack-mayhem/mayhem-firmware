...
/**
 * @brief   PWM Master Clock = MCK / 1, 2, 4, 8, 16, 32, 64, 128, 256, 512,
 * 1024, CLKA or CLKB. CLKA or CLKB uses the frequency field
 */
...
/**
 * @brief   Which PWM output pins to turn on. PIN1 is the lowest numbered pin,
 * PIN2 next lowest, and then on some packages PIN3.
 */
