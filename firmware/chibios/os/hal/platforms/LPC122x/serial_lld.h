 ...
 * @brief   UART0 clock.
 */
#define LPC122x_SERIAL_UART0_PCLK (LPC122x_MAINCLK / LPC122x_SERIAL_UART0CLKDIV)

/**
 * @brief   UART0 clock.
 */
#define LPC122x_SERIAL_UART1_PCLK (LPC122x_MAINCLK / LPC122x_SERIAL_UART1CLKDIV)
