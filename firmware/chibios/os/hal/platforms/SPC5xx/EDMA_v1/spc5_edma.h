 ...
 * @api
 */
#define edmaTCDSetWord0(tcdp, src) ((tcdp)->word[0] = (uint32_t)(src))
 ...
 * @api
 */
#define edmaTCDSetWord2(tcdp, nbytes) ((tcdp)->word[2] = (uint32_t)(nbytes))
 ...
 * @api
 */
#define edmaTCDSetWord3(tcdp, slast) ((tcdp)->word[3] = (uint32_t)(slast))
 ...
 * @api
 */
#define edmaTCDSetWord4(tcdp, dst) ((tcdp)->word[4] = (uint32_t)(dst))
...
#define edmaTCDSetWord5(tcdp, citer, doff) \
	((tcdp)->word[5] = (((uint32_t)(citer) << 16) | ((uint32_t)(doff) << 0)))
 ...
 * @api
 */
#define edmaTCDSetWord6(tcdp, dlast) ((tcdp)->word[6] = (uint32_t)(dlast))
...
#define edmaTCDSetWord7(tcdp, biter, mode) \
	((tcdp)->word[7] = (((uint32_t)(biter) << 16) | ((uint32_t)(mode) << 0)))
 ...
 * @api
 */
#define edmaChannelSetup(channel, src, dst, soff, doff, ssize, dsize, nbytes, \
												 iter, slast, dlast, mode)                            \
	{                                                                           \
