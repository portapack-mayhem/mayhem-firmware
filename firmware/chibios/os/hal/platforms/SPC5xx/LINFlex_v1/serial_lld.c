...
static void spc5_linflex_init(SerialDriver* sdp, const SerialConfig* config) {
	...
	linflexp->LINIER.R = SPC5_LINIER_DTIE | SPC5_LINIER_DRIE | SPC5_LINIER_BOIE |
											 SPC5_LINIER_FEIE |
...
static void spc5xx_serve_rxi_interrupt(SerialDriver* sdp) {
	...
	sdp->linflexp->UARTSR.R = SPC5_UARTSR_NF | SPC5_UARTSR_DRF | SPC5_UARTSR_PE0;
...
static void spc5xx_serve_err_interrupt(SerialDriver* sdp) {
	...
	sdp->linflexp->UARTSR.R = SPC5_UARTSR_BOF | SPC5_UARTSR_FEF | SPC5_UARTSR_SZF;
