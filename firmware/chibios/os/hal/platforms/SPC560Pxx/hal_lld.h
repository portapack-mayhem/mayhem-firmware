...
#define SPC5_ME_ME_BITS                                                     \
	(SPC5_ME_ME_RUN1 | SPC5_ME_ME_RUN2 | SPC5_ME_ME_RUN3 | SPC5_ME_ME_HALT0 | \
	 SPC5_ME_ME_STOP0)
#endif
...
#define SPC5_ME_TEST_MC_BITS                                          \
	(SPC5_ME_MC_SYSCLK_IRC | SPC5_ME_MC_IRCON | SPC5_ME_MC_XOSC0ON |    \
	 SPC5_ME_MC_PLL0ON | SPC5_ME_MC_PLL1ON | SPC5_ME_MC_CFLAON_NORMAL | \
...
#define SPC5_ME_DRUN_MC_BITS                                          \
	(SPC5_ME_MC_SYSCLK_FMPLL0 | SPC5_ME_MC_IRCON | SPC5_ME_MC_XOSC0ON | \
	 SPC5_ME_MC_PLL0ON | SPC5_ME_MC_PLL1ON | SPC5_ME_MC_CFLAON_NORMAL | \
	 SPC5_ME_MC_DFLAON_NORMAL | SPC5_ME_MC_MVRON)
#endif
...
#define SPC5_ME_RUN_PC1_BITS                                         \
	(SPC5_ME_RUN_PC_TEST | SPC5_ME_RUN_PC_SAFE | SPC5_ME_RUN_PC_DRUN | \
	 SPC5_ME_RUN_PC_RUN0 | SPC5_ME_RUN_PC_RUN1 | SPC5_ME_RUN_PC_RUN2 | \
	 SPC5_ME_RUN_PC_RUN3)
#endif
...
#define SPC5_ME_RUN_PC2_BITS                                         \
	(SPC5_ME_RUN_PC_DRUN | SPC5_ME_RUN_PC_RUN0 | SPC5_ME_RUN_PC_RUN1 | \
	 SPC5_ME_RUN_PC_RUN2 | SPC5_ME_RUN_PC_RUN3)
#endif
...
#define SPC5_ME_LP_PC1_BITS (SPC5_ME_LP_PC_HALT0 | SPC5_ME_LP_PC_STOP0)
#endif
...
#define SPC5_ME_LP_PC4_BITS (SPC5_ME_LP_PC_HALT0 | SPC5_ME_LP_PC_STOP0)
#endif
...
#define SPC5_ME_LP_PC5_BITS (SPC5_ME_LP_PC_HALT0 | SPC5_ME_LP_PC_STOP0)
#endif
...
#define SPC5_ME_LP_PC6_BITS (SPC5_ME_LP_PC_HALT0 | SPC5_ME_LP_PC_STOP0)
#endif
...
#define SPC5_ME_LP_PC7_BITS (SPC5_ME_LP_PC_HALT0 | SPC5_ME_LP_PC_STOP0)
#endif
...
#if (SPC5_XOSC_CLK < SPC5_XOSC_CLK_MIN) || (SPC5_XOSC_CLK > SPC5_XOSC_CLK_MAX)
 ...
 */
#define SPC5_FMPLL0_CLK (SPC5_FMPLL0_VCO_CLK / SPC5_FMPLL0_ODF_VALUE)
...
#error \
		"SPC5_FMPLL1_VCO_CLK outside acceptable range (SPC5_FMPLLVCO_MIN...SPC5_FMPLLVCO_MAX)"
#endif

/**
 * @brief   SPC5_FMPLL1_CLK clock point.
 */
#define SPC5_FMPLL1_CLK (SPC5_FMPLL1_VCO_CLK / SPC5_FMPLL1_ODF_VALUE)
...
#elif (SPC5_FMPLL1_CLK_DIVIDER_VALUE >= 1) && \
		(SPC5_FMPLL1_CLK_DIVIDER_VALUE <= 16)
