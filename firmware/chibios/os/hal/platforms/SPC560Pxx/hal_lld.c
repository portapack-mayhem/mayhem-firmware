...
void hal_lld_init(void) {
	...
	halSPCSetPeripheralClockMode(92, SPC5_ME_PCTL_RUN(2) | SPC5_ME_PCTL_LP(2));
...
void spc_clock_init(void) {
	...
	ME.DRUN.R = SPC5_ME_MC_SYSCLK_IRC | SPC5_ME_MC_IRCON | SPC5_ME_MC_XOSC0ON |
							SPC5_ME_MC_CFLAON_NORMAL | SPC5_ME_MC_DFLAON_NORMAL |
							SPC5_ME_MC_MVRON;
	...
	CGM.FMPLL[0].CR.R = SPC5_FMPLL0_ODF | ((SPC5_FMPLL0_IDF_VALUE - 1) << 26) |
											(SPC5_FMPLL0_NDIV_VALUE << 16);
	CGM.FMPLL[0].MR.R = 0; /* TODO: Add a setting.     */
	CGM.FMPLL[1].CR.R = SPC5_FMPLL1_ODF | ((SPC5_FMPLL1_IDF_VALUE - 1) << 26) |
