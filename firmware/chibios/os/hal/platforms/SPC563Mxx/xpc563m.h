...
struct FMPLL_tag {
	...
	} ESYNCR1; /* Enhanced Synthesizer Control Register 1 (ESYNCR1) (new in
								MPC563xM) Offset 0x0008 */
	union {
		vuint32_t R;
		struct {
			vuint32_t : 8;
	...
	} ESYNCR2; /* Enhanced Synthesizer Control Register 2 (ESYNCR2) (new in
								MPC563xM) Offset 0x000C */
	...
	} SYNFMMR; /* Synthesizer FM Modulation Register (SYNFMMR) (new in MPC563xM)
								Offset 0x0018 */
};
/****************************************************************************/
/*                     MODULE : EBI                                      */
...
struct EBI_tag {
	...
	} MCR; /* EBI Module Configuration Register (MCR) <URM>EBI_MCR</URM>
						@baseaddress + 0x00 */
	...
	} TESR; /* EBI Transfer Error Status Register (TESR) <URM>EBI_TESR</URM>
						 @baseaddress + 0x08 */
...
struct FLASH_tag {
	union { /* Module Configuration Register (MCR)@baseaddress + 0x00 */
		...
		struct {
			...
			vuint32_t EER : 1;
					/* ECC Event Error (Read/Clear) */ /* <LEGACY> BBEPE and EPE </LEGACY>
																							*/
	...
	union { /* Low/Mid-Address Space Block Locking Register (LML)@baseaddress +
						 0x04 */
		vuint32_t R;
		struct {
			...
			vuint32_t SLOCK : 1;
					/*<URM>SLK</URM> */ /* Shadow address space block lock (Read/Write) */
			vuint32_t : 2;					/* Reserved */
			vuint32_t MLOCK : 2;
					/*<URM>MLK</URM> */ /* Mid address space block lock (Read/Write) */
			vuint32_t : 8;					/* Reserved */
			vuint32_t LLOCK : 8;
					/*<URM>LLK</URM> */ /* Low address space block lock (Read/Write) */
		} B;
	} LMLR; /*<URM>LML</URM> */

	union { /* High-Address Space Block Locking Register (HBL) - @baseaddress +
						 0x08 */
		vuint32_t R;
		struct {
	...
	union { /* Secondary Low/Mid-Address Space Block Locking Register
						 (SLL)@baseaddress + 0x0C */
		vuint32_t R;
		struct {
			vuint32_t SLE : 1; /* Secondary low/mid address space block enable (Read
														Only) */
			vuint32_t : 10;		 /* Reserved */
			vuint32_t SSLOCK : 1;
					/*<URM>SSLK</URM> */ /* Secondary shadow address space block lock
																	(Read/Write) */
			vuint32_t : 2;					 /* Reserved */
			vuint32_t SMLOCK : 2; /*<URM>SMK</URM> */ /* Secondary mid address space
																									 block lock (Read/Write) */
			vuint32_t : 8;														/* Reserved */
			vuint32_t SLLOCK : 8; /*<URM>SLK</URM> */ /* Secondary low address space
																									 block lock (Read/Write) */
		} B;
	} SLMLR; /*<URM>SLL</URM> */

	union { /* Low/Mid-Address Space Block Select Register (LMS)@baseaddress +
						 0x10 */
		vuint32_t R;
		struct {
			vuint32_t : 14; /* Reserved */
			vuint32_t MSEL : 2;
					/*<URM>MSL</URM> */ /* Mid address space block select (Read/Write) */
			vuint32_t : 8;					/* Reserved */
			vuint32_t LSEL : 8;
					/*<URM>LSL</URM> */ /* Low address space block select (Read/Write) */
		} B;
	} LMSR; /*<URM>LMS</URM> */

	union { /* High-Address Space Block Select Register (HBS) - not
						 used@baseaddress + 0x14 */
		vuint32_t R;
		struct {
			vuint32_t : 28; /* Reserved */
			vuint32_t HBSEL : 4;
					/*<URM>HSL</URM> */ /* High address space block select (Read/Write) */
		} B;
	} HSR; /*<URM>HBS</URM> */
	...
	union { /* @baseaddress + 0x1C */
		...
		struct {
			...
			vuint32_t : 1;			 /* Reserved */
			vuint32_t DPFEN : 1;
					/*<URM>DPFE</URM> */ /* Data Prefetch Enable (Read/Write) */
			vuint32_t : 1;					 /* Reserved */
			vuint32_t IPFEN : 1;
					/*<URM>IPFE</URM> */ /* Instruction Prefetch Enable (Read/Write) */
			vuint32_t : 1;					 /* Reserved */
	...
	union { /* @baseaddress + 0x28 */
		...
		struct {
			...
			vuint32_t : 1;				 /* Reserved */
			vuint32_t
					B1_IPFE : 1; /* Bank1 Instruction Prefetch Enable (Read/Write) */
			vuint32_t : 1;	 /* Reserved */
	...
	union { /* User Multiple Input Signature Register 0-5 (UMISR[5])@baseaddress +
						 0x48 */
		vuint32_t R;
		struct {
...
struct SIU_tag {
	union {
		...
		struct {
			...
			vuint32_t
					FLASH_SIZE_1 : 4; /* Define major Flash memory size (see Table 15-4
															 for details) <URM>Flash Size 1</URM> */
			vuint32_t FLASH_SIZE_2 : 4; /* Define Flash memory size, small granularity
																		 (see Table 15-5 for details) <URM>Flash
																		 Size 1</URM> */
			vuint32_t TEMP_RANGE : 2;		/* Define maximum operating range <URM>Temp
																		 Range</URM> */
			vuint32_t : 1;							/* Reserved for future enhancements */
			vuint32_t
					MAX_FREQ : 2; /* Define maximum device speed <URM>Max Freq</URM> */
			vuint32_t : 1;		/* Reserved for future enhancements */
			vuint32_t
					SUPPLY : 1; /* Defines if the part is 5V or 3V <URM>Supply</URM> */
			vuint32_t PART_NUMBER : 8; /* Contain the ASCII representation of the
																		character that indicates the product
																		<URM>Part Number</URM> */
			vuint32_t TBD : 1; /* 1-bit field defined by SoC to describe optional
														feature, e.g., additional SPI */
	...
	union {
		...
		struct {
			...
			vuint32_t PKG : 5; /* Indicate the package the die is mounted in. (new in
														MPC563xM)  */
			vuint32_t : 2;		 /* Reserved */
			vuint32_t MASKNUM : 8; /* MCU major mask number; updated for each complete
																resynthesis. MCU minor mask number; updated for
																each mask revision */
		} B;
	...
	union {
		...
		struct {
			...
			vuint32_t SWTRS : 1;	 /*  Software Watchdog Timer Reset Status (new in
																MPC563xM) */
			vuint32_t : 7;				 /*  */
	...
	} RSR; /* Reset Status Register (SIU_RSR) <URM>SIU_RSR</URM> @baseaddress +
						0x10 */
	...
	} SRCR; /* System Reset Control Register (SRCR) <URM>SIU_SRCR</URM>
						 @baseaddress + 0x14 */
	...
	union {
		...
		struct {
			...
			vuint32_t : 7;			 /*  */
			vuint32_t SWT : 1;	 /* Software Watch Dog Timer Interrupt Flag, from
															platform (new in MPC563xM) */
			vuint32_t : 7;			 /*  */
	...
	} EISR; /* SIU External Interrupt Status Register (EISR) <URM>SIU_EISR</URM>
						 @baseaddress + 0x18 */

	union {
		vuint32_t R;
		struct {
			vuint32_t NMI_SEL : 1; /* NMI Interrupt Platform Input Selection (new in
																MPC563xM) */
			vuint32_t : 7;				 /*  */
			vuint32_t SWT_SEL : 1;
			vuint32_t : 7;
	...
	} DIRER; /* DMA/Interrupt Request Enable Register (DIRER) <URM>SIU_DIRER</URM>
							@baseaddress + 0x1C */
	...
	} DIRSR; /* DMA/Interrupt Request Select Register (DIRSR) <URM>SIU_DIRSR</URM>
							@baseaddress + 0x20 */
	...
	} ORER; /* Overrun Request Enable Register (ORER) <URM>SIU_ORER</URM>
						 @baseaddress + 0x28 */
	...
	union {
		...
		struct {
			vuint32_t
					NMIRE : 1;	/* NMI Rising-Edge Event Enable x (new in MPC563xM) */
	...
	} IREER; /* External IRQ Rising-Edge Event Enable Register (IREER)
							<URM>SIU_IREER</URM> @baseaddress + 0x2C */

	union {
		vuint32_t R;
		struct {
			vuint32_t
					NMIFE : 1; /* NMI Falling-Edge Event Enable x (new in MPC563xM) */
	...
	} IFEER; /* External IRQ Falling-Edge Event Enable Regi (IFEER)
							<URM>SIU_IFEER</URM> @baseaddress + 0x30 */
	...
	} IDFR; /* External IRQ Digital Filter Register (IDFR) <URM>SIU_IDFR</URM>
						 @baseaddress + 0x40 */
	...
	} PCR[512]; /* Pad Configuration Register  (PCR) <URM>SIU_PCR</URM>
								 @baseaddress + 0x600 */
	...
	} GPDO[512]; /* GPIO Pin Data Output Register (GPDO) <URM>SIU_GDPO</URM>
									@baseaddress + 0x800 */
	...
	} GPDI[256]; /* GPIO Pin Data Input Register (GDPI) <URM>SIU_GDPI</URM>
									@baseaddress + 0x900 */
	...
	} ETISR; /* eQADC Trigger Input Select Register (ETISR) <URM>SIU_ETISR</URM>
							@baseaddress + 0x904 */
	...
	} EIISR; /* External IRQ Input Select Register (EIISR) <URM>SIU_EIISR</URM>
							@baseaddress + 0x908 */
	...
	union {
		...
		struct {
			...
			vuint32_t
					SSSELB : 2; /* DSPI_B Slave Select Input Select <URM>SS-SELB</URM> */
			vuint32_t SCKSELB : 2; /* DSPI_B Clock Input Select <URM>SCK-SELB</URM> */
			vuint32_t
					TRIGSELB : 2; /* DSPI_B Trigger Input Select <URM>TRIG-SELB</URM> */
			vuint32_t SINSELC : 2; /* DSPI_C Data Input Select <URM>SIN-SELC</URM> */
			vuint32_t
					SSSELC : 2; /* DSPI_C Slave Select Input Select <URM>SSSELC</URM> */
			vuint32_t SCKSELC : 2; /* DSPI_C Clock Input Select <URM>SCK-SELC</URM> */
			vuint32_t
					TRIGSELC : 2; /* DSPI_C Trigger Input Select <URM>TRIG-SELC</URM> */
			vuint32_t : 8;		/* reserved in MPC563xM */
		} B;
	} DISR; /* DSPI Input Select Register (DISR) <URM>SIU_DISR</URM> @baseaddress
						 + 0x90c */
	...
	} ISEL3; /* MUX Select Register 3 (ISEL3) (new in MPC563xM)
							<URM>SIU_ISEL3</URM> @baseaddress + 0x920 */
	...
	} ISEL8; /* MUX Select Register 8 (ISEL8) (new in MPC563xM)
							<URM>SIU_ISEL8</URM> @baseaddress + 0x924 */
	...
	} ISEL9; /* MUX Select Register 9(ISEL9) <URM>SIU_ISEL9</URM> @baseaddress +
							0x980 */
	...
	union {
		...
		struct {
			...
			vuint32_t : 14;				/*  */
			vuint32_t CRSE : 1; /*  Calibration Reflection Suppression Enable (new in
														 MPC563xM) */
			vuint32_t : 1;			/*  */
		} B;
	} CCR; /* Chip Configuration Register (CCR) <URM>SIU_CCR</URM> @baseaddress +
						0x984 */
	...
	} ECCR; /* External Clock Control Register (ECCR) <URM>SIU_ECCR</URM>
						 @baseaddress + 0x988 */

	union {
		vuint32_t R;
	} CARH; /* Compare A High Register (CARH) <URM>SIU_CMPAH</URM> @baseaddress +
						 0x98C */

	union {
		vuint32_t R;
	} CARL; /* Compare A Low Register (CARL) <URM>SIU_CMPAL</URM> @baseaddress +
						 0x990 */

	union {
		vuint32_t R;
	} CBRH; /* Compare B High Register (CBRH) <URM>SIU_CMPBH</URM> @baseaddress +
						 0x994 */

	union {
		vuint32_t R;
	} CBRL; /* Compare B Low Register (CBRL)  <URM>SIU_CMPBL</URM> @baseaddress +
						 0x9A0 */
	...
	} SYSDIV; /* System Clock Register (SYSDIV) (new in MPC563xM)
							 <URM>SIU_SYSDIV</URM>  @baseaddress + 0x9A4 */

	union {
		vuint32_t R;
		struct {
			vuint32_t CPUSTP : 1; /* CPU stop request. When asserted, a stop request
															 is sent to the following modules: */
			vuint32_t : 2;				/* Reserved */
			vuint32_t SWTSTP : 1; /* SWT stop request. When asserted, a stop request
															 is sent to the Software Watchdog */
			vuint32_t : 1;				/* Reserved */
			vuint32_t TPUSTP : 1; /* eTPU stop request. When asserted, a stop request
															 is sent to the eTPU module. */
			vuint32_t NPCSTP : 1; /* Nexus stop request. When asserted, a stop request
															 is sent to the Nexus Controller. */
			vuint32_t EBISTP : 1; /* EBI stop request. When asserted, a stop request
															 is sent to the external bus */
			vuint32_t ADCSTP : 1; /* eQADC stop request. When asserted, a stop request
															 is sent to the eQADC module. */
			vuint32_t : 1;				/* Reserved */
			vuint32_t MIOSSTP : 1; /* Stop mode request */
			vuint32_t DFILSTP : 1; /* Decimation filter stop request. When asserted, a
																stop request is sent to the */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t PITSTP : 1;	 /* PIT stop request. When asserted, a stop request
																is sent to the periodical internal */
			vuint32_t : 3;				 /* Reserved */
			vuint32_t CNCSTP : 1;	 /* FlexCAN C stop request. When asserted, a stop
																request is sent to the FlexCAN C */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t CNASTP : 1;	 /* FlexCAN A stop request. When asserted, a stop
																request is sent to the FlexCAN A */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t SPICSTP : 1; /* DSPI C stop request. When asserted, a stop
																request is sent to the DSPI C. */
			vuint32_t SPIBSTP : 1; /* DSPI B stop request. When asserted, a stop
																request is sent to the DSPI B. */
			vuint32_t : 7;				 /* Reserved */
			vuint32_t SCIBSTP : 1; /* eSCI B stop request. When asserted, a stop
																request is sent to the eSCI B module. */
			vuint32_t SCIASTP : 1; /* eSCI A stop request. When asserted, a stop
																request is sent to the eSCIA module. */
		} B;
	} HLT; /* Halt Register (HLT) (new in MPC563xM) <URM>SIU_HLT</URM>
						@baseaddress + 0x9A8 */

	union {
		vuint32_t R;
		struct {
			vuint32_t CPUACK : 1;	 /* CPU stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t : 2;				 /* Reserved */
			vuint32_t SWTACK : 1;	 /* SWT stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t TPUACK : 1;	 /* eTPU stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t NPCACK : 1;	 /* Nexus stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t EBIACK : 1;	 /* EBI stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t ADCACK : 1;	 /* eQADC stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t MIOSACK : 1; /* eMIOS stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t DFILACK : 1; /* Decimation filter stop acknowledge. When
																asserted, indicates that a stop */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t PITACK : 1;	 /* PIT stop acknowledge. When asserted, indicates
																that a stop acknowledge was */
			vuint32_t : 3;				 /* Reserved */
			vuint32_t CNCACK : 1;	 /* FlexCAN C stop acknowledge. When asserted,
																indicates that a stop acknowledge */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t CNAACK : 1;	 /* FlexCAN A stop acknowledge. When asserted,
																indicates that a stop acknowledge */
			vuint32_t : 1;				 /* Reserved */
			vuint32_t SPICACK : 1; /* DSPI C stop acknowledge. When asserted,
																indicates that a stop acknowledge was */
			vuint32_t SPIBACK : 1; /* DSPI B stop acknowledge. When asserted,
																indicates that a stop acknowledge was */
			vuint32_t : 7;				 /* Reserved */
			vuint32_t SCIBACK : 1; /* eSCI B stop acknowledge */
			vuint32_t SCIAACK : 1; /* eSCI A stop acknowledge. */
		} B;
	} HLTACK; /* Halt Acknowledge Register (HLTACK) (new in MPC563xM)
							 <URM>SIU_HLTACK</URM> @baseaddress + 0x9ac */
...
struct EMIOS_tag {
	...
	} UCDIS; /* Disable Channel (EMIOSUCDIS) <URM>EMIOSUCDIS</URM> (new in
							MPC563xM) @baseaddress + 0x0C */
...
struct ETPU_tag { /* offset 0x0000 */
	union {					/* eTPU module configuration register@baseaddress + 0x00 */
		...
		struct {
			...
			vuint32_t
					ILF1 : 1; /* Invalid instruction flag eTPU A. <URM>ILFFA</URM> */
			vuint32_t
					ILF2 : 1; /* Invalid instruction flag eTPU B. <URM>ILFFB</URM> */
			vuint32_t SCMERR : 1;		/* . */
			vuint32_t : 2;					/*  */
	...
	union { /* eTPU coherent dual-parameter controller register@baseaddress + 0x04
		...
		struct {
			...
			vuint32_t
					PBASE : 10; /*  Parameter Buffer Base Address  <URM>PBBASE</URM> */
	...
	union { /* eTPU MISC Compare Register@baseaddress + 0x0c */
		...
		struct {
			vuint32_t
					ETPUMISCCMP : 32; /* Expected multiple input signature calculator
															 compare register value. <URM>EMISCCMP</URM> */
		} B;
	...
	/* offset 0x0020 */
	union { /* eTPU Time Base Configuration Register (ETPU_TBCR)@baseaddress +
						 0x20 */
		vuint32_t R;
		struct {
	...
	/* offset 0x0024 */
	union { /* eTPU Time Base 1 (TCR1) Visibility Register (ETPU_TB1R)@baseaddress
						 + 0x24 */
		vuint32_t R;
		struct {
			vuint32_t : 8;			 /*  */
			vuint32_t TCR1 : 24; /* TCR1 value. Used on matches and captures. For more
															information, see the eTPU reference manual. */
		} B;
	} TB1R_A; /*<URM>ETPU_TB1R</URM> */

	/* offset 0x0028 */
	union { /* eTPU Time Base 2 (TCR2) Visibility Register (ETPU_TB2R)@baseaddress
						 + 0x28 */
		vuint32_t R;
		struct {
			vuint32_t : 8; /*  */
			vuint32_t
					TCR2 : 24; /* TCR2 value. Used on matches and captures. For
												information on TCR2, see the eTPU reference manual. */
		} B;
	...
	/* offset 0x0200 */
	union { /* eTPU Channel Interrupt Status Register (ETPU_CISR)@baseaddress +
						 0x200 */
		vuint32_t R;
		struct {
	...
	/* offset 0x0220 */
	union { /* eTPU Channel Interrupt Overflow Status Register
						 (ETPU_CIOSR)@baseaddress + 0x220 */
		vuint32_t R;
		struct {
	...
	/* offset 0x0230 */
	union { /* eTPU Channel Data Transfer Request Overflow Status
						 Register@baseaddress + 0x230 */
		vuint32_t R;
		struct {
	...
	/* offset 0x0240 */
	union { /* eTPU Channel Interrupt Enable Register (ETPU_CIER)@baseaddress +
						 0x240 */
		vuint32_t R;
		struct {
	...
	/* offset 0x0250 */
	union { /* eTPU Channel Data Transfer Request Enable Register
						 (ETPU_CDTRER)@baseaddress + 0x250 */
		vuint32_t R;
		struct {
	...
	struct {
		union { /* eTPU Channel n Configuration Register (ETPU_CnCR)@baseaddress +
							 0x400 */
			vuint32_t R;
			struct {
				...
				vuint32_t : 2;			 /*  */
				vuint32_t ETPD : 1;	 /*  This bit selects which channel signal, input or
																output, is used in the entry point selection */
		...
		union { /* eTPU Channel n Status Control Register (ETPU_CnSCR)@baseaddress +
							 0x404 */
			vuint32_t R;
			struct {
		...
		union { /* eTPU channel host service request register
							 (ETPU_CnHSRR)@baseaddress + 0x408 */
			vuint32_t R;
			struct {
	...
	/**** Note: Not all channels implemented on all devices. Up 64 can be
	 * implemented on */
}; /* end of ETPU_tag */
/****************************************************************************/
/*                     MODULE : XBAR                                      */
...
struct XBAR_tag {
	union {
		...
		struct {
			...
			vuint32_t : 1; /*  */
			vuint32_t
					MSTR4 : 3; /* Master 4 Priority - Core load/store & Nexus port */
			vuint32_t : 4; /* Master 3 Priority - Not implemented */
			vuint32_t : 1; /*  */
			vuint32_t
					MSTR2 : 3; /* Master 2 Priority - Unused implemented master port */
			vuint32_t : 1; /*  */
			vuint32_t MSTR1 : 3; /* Master 1 Priority - eDMA */
			vuint32_t : 1;			 /*  */
			vuint32_t MSTR0 : 3; /* Master 0 Priority - e200z335 core Instruction */
		} B;
	} MPR0; /* Master Priority Register for Slave port 0 @baseaddress + 0x00  -
						 Flash */
	...
	/* Slave General Purpose Control Register 2 @baseaddress + 0x210  - not
	 * implemented */
	...
	/* Slave General Purpose Control Register 4 @baseaddress + 0x410 - not
	 * implemented */
	...
	/* Master General Purpose Control Register 3 not implemented @baseaddress +
	 * 0xB00 */
	...
	/* Master General Purpose Control Register 5 not implemented @baseaddress +
	 * 0xD00 */

	int32_t XBAR_reserverd_579[64];

	/* Master General Purpose Control Register 6 not implemented @baseaddress +
	 * 0xE00 */

	int32_t XBAR_reserverd_582[64];

	/* Master General Purpose Control Register 7 not implemented @baseaddress +
	 * 0xF00 */
...
struct EDMA_tag {
	...
	union {
		...
		struct {
			...
			vuint32_t ERRCHN : 6; /* ERRCHN[5:0] Error Channel Number or The channel
															 number of the last recorded error */
	...
	struct tcd_t {		 /*for "standard" format TCDs (when
												EDMA.TCD[x].CITER.E_LINK==BITER.E_LINK=0 && EDMA.EMLM=0 ) */
...
struct EDMA_TCD_alt1_tag { /*for alternate format TCDs (when
															EDMA.TCD[x].CITER.E_LINK==BITER.E_LINK=1 ) */
...
struct INTC_tag {
	union {
		...
		struct {
			...
			vuint32_t VTES_PRC1 : 1; /* Vector Table Entry Size for PRC1 (new in
																	MPC563xM) */
			vuint32_t : 4;					 /* Reserved */
			vuint32_t
					HVEN_PRC1 : 1; /* Hardware Vector Enable for PRC1 (new in MPC563xM) */
			vuint32_t : 2;		 /* Reserved */
			vuint32_t
					VTES : 1;	 /* Vector Table Entry Size for PRC0 <URM>VTES_PRC0</URM> */
			vuint32_t : 4; /* Reserved */
			vuint32_t
					HVEN : 1; /* Hardware Vector Enable for PRC0 <URM>HVEN_PRC0</URM> */
		} B;
	} MCR; /* INTC Module Configuration Register (MCR) <URM>INTC_BCR</URM>
						@baseaddress + 0x00 */
	...
	} CPR; /* INTC Current Priority Register for Processor 0 (CPR)
						<URM>INTC_CPR_PRC0</URM> @baseaddress + 0x08 */

	int32_t INTC_reserved_1; /* CPR_PRC1 - INTC Current Priority Register for
															Processor 1 (CPR_PRC1) <URM>INTC_CPR_PRC1</URM>
															@baseaddress + 0x0c */
	...
	} IACKR; /* INTC Interrupt Acknowledge Register for Processor 0 (IACKR)
							<URM>INTC_IACKR_PRC0</URM> @baseaddress + 0x10 */

	int32_t INTC_reserverd_2; /* IACKR_PRC1 - INTC Interrupt Acknowledge Register
															 for Processor 1 (IACKR_PRC1)
															 <URM>INTC_IACKR_PRC1</URM> @baseaddress + 0x14 */

	union {
		vuint32_t R;
	} EOIR; /* INTC End of Interrupt Register for Processor 0 (EOIR)
						 <URM>INTC_EOIR_PRC0</URM> @baseaddress + 0x18 */

	int32_t INTC_reserverd_3; /* EOIR_PRC1 -  INTC End of Interrupt Register for
															 Processor 1 (EOIR_PRC1) <URM>INTC_EOIR_PRC1</URM>
															 @baseaddress + 0x1C */
	...
	} SSCIR[8]; /* INTC Software Set/Clear Interrupt Registers (SSCIR)
								 <URM>INTC_SSCIRn</URM> @baseaddress + 0x20 */
	...
	} PSR[512]; /* INTC Priority Select Registers (PSR) <URM>INTC_PSR</URM>
								 @baseaddress + 0x40 */
...
struct EQADC_tag {
	...
	} SSIRDR; /* SSI Recieve Data Register <URM>EQADC_SSIRDR</URM> @ baseaddress +
							 0xB8 */

	uint32_t eqadc_reserved11b[5];

	uint32_t eqadc_reserved15; /* EQADC Red Line Client Configuration Register @
																baseaddress + 0xD0  */
...
struct DSPI_tag {
	...
	} MCR; /* Module Configuration Register <URM>DSPI_MCR</URM> @baseaddress +
						0x00 */
	...
	} TCR; /* DSPI Transfer Count Register  <URM>DSPI_TCR</URM> @baseaddress +
						0x08 */
	...
	} CTAR[8]; /* Clock and Transfer Attributes Registers <URM>DSPI_CTARx</URM>
								@baseaddress + 0x0C - 0x28 */
	...
	union {
		...
		struct {
			...
			vuint32_t : 16;
						 ...
						 <URM>DSPI_RSER</URM> @baseaddress + 0x30 */
	...
	} TXFR[4]; /* Transmit FIFO Registers <URM>DSPI_TXFRx</URM> @baseaddress +
								0x3c - 0x78 */
	...
	} RXFR[4]; /* Transmit FIFO Registers <URM>DSPI_RXFRx</URM> @baseaddress +
								0x7c - 0xB8 */
	...
	} DSICR; /* DSI Configuration Register <URM>DSPI_DSICR</URM> @baseaddress +
							0xBC */
	...
	} SDR; /* DSI Serialization Data Register <URM>DSPI_SDR</URM> @baseaddress +
						0xC0 */
	...
	} ASDR; /* DSI Alternate Serialization Data Register <URM>DSPI_ASDR</URM>
						 @baseaddress + 0xC4 */
	...
	} COMPR; /* DSI Transmit Comparison Register <URM>DSPI_COMPR</URM>
							@baseaddress + 0xC8 */
	...
	} DDR; /* DSI deserialization Data Register <URM>DSPI_DDR</URM> @baseaddress +
						0xCC */
	...
	} DSICR1; /* DSI Configuration Register 1 <URM>DSPI_DSICR1</URM> @baseaddress
							 + 0xD0 */
};
/****************************************************************************/
/*                          MODULE : eSCI                                   */
...
struct ESCI_tag {
	...
	} CR1; /* Control Register 1 <URM>SCIBDH, SCIBDL, SCICR1, SCICR2</URM>
						@baseaddress + 0x00 */
	...
	} SR; /* Status Register <URM>SCISR1, SCIRSR2, LINSTAT1, LINSTAT2 </URM>
					 @baseaddress + 0x08 */
	...
	} LCR; /* LIN Control Register <URM>LINCTRL1, LINCTRL2, LINCTRL3 </URM>
						@baseaddress + 0x0C  */
	...
	} LPR; /* LIN CRC Polynom Register  <URM>LINCRCP1, LINCRCP2, SCICR5</URM>
						@baseaddress + 0x18 */
};
/****************************************************************************/
/*                          MODULE : eSCI                                   */
...
struct FLEXCAN_BUF_t {
	...
	union {
		/*vuint8_t  B[8]; */ /* Data buffer in Bytes (8 bits) */ /* Not used in
																																MPC563xM */
		/*vuint16_t H[4]; */ /* Data buffer in Half-words (16 bits) */ /* Not used
																																			in
																																			MPC563xM
																																		*/
		vuint32_t W[2]; /* Data buffer in words (32 bits) */
		/*vuint32_t R[2]; */ /* Data buffer in words (32 bits) */ /* Not used in
																																 MPC563xM */
	} DATA;
...
struct FLEXCAN2_tag {
	...
	uint32_t FLEXCAN_reserved3[256];
			/* {0x0880-0x0480}/0x4 = 0x100 */ /* (New in MPC563xM) Address Base +
																					 0x0034 */
...
struct DECFIL_tag {
	...
	/* Module Extended Config.Register - not siupported on the MPC563xM
	 * <URM>DECFILTER_MXCR</URM> @baseaddress + 0x08  */
	...
	} COEF[9]; /* Filter Coefficient Registers <URM>DECFILTER_COEFx</URM>
								@baseaddress + 0x20 - 0x40  */
	...
	} TAP[8]; /* Filter TAP Registers <URM>DECFILTER_TAPx</URM> @baseaddress +
							 0x78 - 0x94 */
	...
	/* Filter FINTVAL Registers - Not supported on MPC563xM
	 * <URM>DECFILTER_FINTVAL</URM> @baseaddress + 0xE0 */

	/* 0x0E4 */
	uint32_t decfil_reserved7;
	/* Filter FINTCNT Registers - Not supported on MPC563xM
	 * <URM>DECFILTER_FINTCNT</URM> @baseaddress + 0xE4 */

	/* 0x0E8 */
	uint32_t decfil_reserved8;
	/* Filter CINTVAL Registers - Not supported on MPC563xM
	 * <URM>DECFILTER_CINTVAL</URM> @baseaddress + 0xE8 */

	/* 0x0EC */
	uint32_t decfil_reserved9;
	/* Filter CINTCNT Registers - Not supported on MPC563xM
	 * <URM>DECFILTER_CINTCNT</URM> @baseaddress + 0xEC */
};
/****************************************************************************/
...
struct STM_tag {
	...
	} CR; /* STM Control Register <URM>STM_CR</URM> (new in MPC563xM) Offset
					 0x0000 */

	union {
		vuint32_t R;
	} CNT; /* STM Count Register <URM>STM_CNT</URM> (new in MPC563xM) Offset
						Offset 0x0004 */

	uint32_t
			stm_reserved1[2]; /* Reserved (new in MPC563xM) Offset Offset 0x0008 */
	...
	} CCR0; /* STM Channel Control Register <URM>STM_CCR0</URM> (new in MPC563xM)
						 Offset 0x0010 */
	...
	} CIR0; /* STM Channel Interrupt Register <URM>STM_CIR0</URM> (new in
						 MPC563xM) Offset 0x0014 */

	union {
		vuint32_t R;
	} CMP0; /* STM Channel Compare Register <URM>STM_CMP0</URM> (new in MPC563xM)
						 Offset Offset 0x0018 */
	...
	} CCR1; /* STM Channel Control Register <URM>STM_CCR1</URM> (new in MPC563xM)
						 Offset 0x0020 */
	...
	} CIR1; /* STM Channel Interrupt Register <URM>STM_CIR1</URM> (new in
						 MPC563xM) Offset 0x0024 */

	union {
		vuint32_t R;
	} CMP1; /* STM Channel Compare Register <URM>STM_CMP1</URM> (new in MPC563xM)
						 Offset Offset 0x0028 */
	...
	} CCR2; /* STM Channel Control Register <URM>STM_CCR2</URM> (new in MPC563xM)
						 Offset 0x0030 */
	...
	} CIR2; /* STM Channel Interrupt Register <URM>STM_CIR2</URM> (new in
						 MPC563xM) Offset 0x0034 */

	union {
		vuint32_t R;
	} CMP2; /* STM Channel Compare Register <URM>STM_CMP2</URM> (new in MPC563xM)
						 Offset Offset 0x0038 */
	...
	} CCR3; /* STM Channel Control Register <URM>STM_CCR3</URM> (new in MPC563xM)
						 Offset 0x0040 */
	...
	} CIR3; /* STM Channel Interrupt Register <URM>STM_CIR3</URM> (new in
						 MPC563xM) Offset 0x0044 */

	union {
		vuint32_t R;
	} CMP3; /* STM Channel Compare Register <URM>STM_CMP3</URM> (new in MPC563xM)
						 Offset Offset 0x0048 */
