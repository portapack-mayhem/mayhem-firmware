...
#define GOTGINT_HNSSCHG                   \
	(1U << 9) /**< Host negotiation success \
								 status change.             */
#define GOTGINT_SRSSCHG                                      \
	(1U << 8)											/**< Session request success \
																		 status change.             */
 ...
 * @{
 */
#define GAHBCFG_PTXFELVL               \
	(1U << 8) /**< Periodic TxFIFO empty \
								 level.                     */
#define GAHBCFG_TXFELVL                                        \
	(1U << 7)											/**< Non-periodic TxFIFO empty \
																		 level.                     */
#define GAHBCFG_DMAEN (1U << 5) /**< DMA enable (HS only).      */
#define GAHBCFG_HBSTLEN_MASK                 \
	(15U << 1) /**< Burst length/type mask (HS \
									only).                     */
#define GAHBCFG_HBSTLEN(n)                                   \
	((n) << 1)											/**< Burst length/type (HS \
																			 only).                     */
...
#define GUSBCFG_TRDT_MASK                    \
	(15U << 10) /**< USB Turnaround time field \
									 mask.                      */
#define GUSBCFG_TRDT(n)                                         \
	((n) << 10)										 /**< USB Turnaround time field \
																			value.                     */
#define GUSBCFG_HNPCAP (1U << 9) /**< HNP-Capable.               */
#define GUSBCFG_SRPCAP (1U << 8) /**< SRP-Capable.               */
#define GUSBCFG_PHYSEL                     \
	(1U << 6) /**< USB 2.0 High-Speed PHY or \
								 USB 1.1 Full-Speed serial \
								 transceiver Select.        */
#define GUSBCFG_TOCAL_MASK                 \
	(7U << 0) /**< HS/FS timeout calibration \
								 field mask.                */
#define GUSBCFG_TOCAL(n)                    \
	((n) << 0) /**< HS/FS timeout calibration \
									field value.               */
/** @} */
...
#define GINTSTS_WKUPINT                \
	(1U << 31) /**< Resume/Remote wakeup \
									detected interrupt.        */
#define GINTSTS_SRQINT                        \
	(1U << 30) /**< Session request/New session \
									detected interrupt.        */
#define GINTSTS_DISCINT                                     \
	(1U << 29)											 /**< Disconnect detected \
																				interrupt.                 */
...
#define GINTSTS_IPXFR                 \
	(1U << 21) /**< Incomplete periodic \
									transfer.                  */
#define GINTSTS_IISOOXFR                     \
	(1U << 21) /**< Incomplete isochronous OUT \
									transfer.                  */
#define GINTSTS_IISOIXFR                                         \
	(1U << 20)											/**< Incomplete isochronous IN \
																			 transfer.                  */
#define GINTSTS_OEPINT (1U << 19) /**< OUT endpoints interrupt.   */
#define GINTSTS_IEPINT (1U << 18) /**< IN endpoints interrupt.    */
#define GINTSTS_EOPF                    \
	(1U << 15) /**< End of periodic frame \
									interrupt.                 */
#define GINTSTS_ISOODRP                                        \
	(1U << 14)											 /**< Isochronous OUT packet \
																				dropped interrupt.         */
...
#define GINTSTS_GINAKEFF                                         \
	(1U << 6)											 /**< Global IN non-periodic NAK \
																			effective.                 */
...
#define GINTMSK_SRQM                          \
	(1U << 30) /**< Session request/New session \
									detected interrupt mask.   */
#define GINTMSK_DISCM                 \
	(1U << 29) /**< Disconnect detected \
									interrupt mask.            */
#define GINTMSK_CIDSCHGM                                          \
	(1U << 28)											/**< Connector ID status change \
																			 mask.                      */
#define GINTMSK_PTXFEM (1U << 26) /**< Periodic TxFIFO empty mask.*/
#define GINTMSK_HCM                                           \
	(1U << 25)										 /**< Host channels interrupt \
																			mask.                      */
#define GINTMSK_HPRTM (1U << 24) /**< Host port interrupt mask.  */
#define GINTMSK_IPXFRM                \
	(1U << 21) /**< Incomplete periodic \
									transfer mask.             */
#define GINTMSK_IISOOXFRM                    \
	(1U << 21) /**< Incomplete isochronous OUT \
									transfer mask.             */
#define GINTMSK_IISOIXFRM                   \
	(1U << 20) /**< Incomplete isochronous IN \
									transfer mask.             */
#define GINTMSK_OEPM                      \
	(1U << 19) /**< OUT endpoints interrupt \
									mask.                      */
#define GINTMSK_IEPM                     \
	(1U << 18) /**< IN endpoints interrupt \
									mask.                      */
#define GINTMSK_EOPFM                   \
	(1U << 15) /**< End of periodic frame \
									interrupt mask.            */
#define GINTMSK_ISOODRPM                                        \
	(1U << 14)												/**< Isochronous OUT packet \
...
#define GINTMSK_GONAKEFFM                 \
	(1U << 7) /**< Global OUT NAK effective \
								 mask.                      */
#define GINTMSK_GINAKEFFM                   \
	(1U << 6) /**< Global non-periodic IN NAK \
								 effective mask.            */
#define GINTMSK_NPTXFEM                    \
	(1U << 5) /**< Non-periodic TxFIFO empty \
								 mask.                      */
#define GINTMSK_RXFLVLM                                    \
	(1U << 4)										 /**< Receive FIFO non-empty \
																		mask.                      */
#define GINTMSK_SOFM (1U << 3) /**< Start of (micro)frame mask.*/
#define GINTMSK_OTGM (1U << 2) /**< OTG interrupt mask.        */
#define GINTMSK_MMISM                    \
	(1U << 1) /**< Mode Mismatch interrupt \
								 mask.                      */
/** @} */
 ...
 * @{
 */
#define DIEPTXF_INEPTXFD_MASK                   \
	(0xFFFFU << 16) /**< IN endpoint TxFIFO depth \
											mask.                      */
#define DIEPTXF_INEPTXFD(n)                 \
	((n) << 16) /**< IN endpoint TxFIFO depth \
									 value.                     */
#define DIEPTXF_INEPTXSA_MASK                   \
	(0xFFFF << 0) /**< IN endpoint FIFOx transmit \
										 RAM start address mask.    */
#define DIEPTXF_INEPTXSA(n)                  \
	((n) << 0) /**< IN endpoint FIFOx transmit \
...
#define GCCFG_VBUSBSEN                        \
	(1U << 19) /**< Enable the VBUS sensing "B" \
									device.                    */
#define GCCFG_VBUSASEN                                           \
	(1U << 18)										/**< Enable the VBUS sensing "A" \
																		 device.                    */
 ...
 * @{
 */
#define HPTXFSIZ_PTXFD_MASK                 \
	(0xFFFFU << 16) /**< Host periodic TxFIFO \
											depth mask.                */
#define HPTXFSIZ_PTXFD(n)               \
	((n) << 16) /**< Host periodic TxFIFO \
									 depth value.               */
#define HPTXFSIZ_PTXSA_MASK                \
	(0xFFFFU << 0) /**< Host periodic TxFIFO \
											Start address mask.        */
#define HPTXFSIZ_PTXSA(n)              \
	((n) << 0) /**< Host periodic TxFIFO \
									start address value.       */
/** @} */
...
#define HCFG_FSLSPCS_MASK               \
	(3U << 0) /**< FS/LS PHY clock select \
								 mask.                      */
#define HCFG_FSLSPCS_48                  \
	(1U << 0) /**< PHY clock is running at \
								 48 MHz.                    */
#define HCFG_FSLSPCS_6                   \
	(2U << 0) /**< PHY clock is running at \
								 6 MHz.                     */
/** @} */
 ...
 * @{
 */
#define HPTXSTS_PTXQTOP_MASK                \
	(0xFFU << 24) /**< Top of the periodic    \
										 transmit request queue \
										 mask.                      */
#define HPTXSTS_PTXQTOP(n)                \
	((n) << 24) /**< Top of the periodic    \
									 transmit request queue \
									 value.                     */
#define HPTXSTS_PTXQSAV_MASK                  \
	(0xFF << 16) /**< Periodic transmit request \
										queue Space Available     \
										mask.                      */
#define HPTXSTS_PTXQSAV(n)                   \
	((n) << 16) /**< Periodic transmit request \
									 queue Space Available     \
									 value.                     */
#define HPTXSTS_PTXFSAVL_MASK               \
	(0xFFFF << 0) /**< Periodic transmit Data \
										 FIFO Space Available   \
										 mask.                      */
#define HPTXSTS_PTXFSAVL(n)              \
	((n) << 0) /**< Periodic transmit Data \
									FIFO Space Available   \
									value.                     */
/** @} */
 ...
 * @{
 */
#define HAINTMSK_HAINTM_MASK                 \
	(0xFFFFU << 0) /**< Channel interrupt mask \
											mask.                      */
#define HAINTMSK_HAINTM(n)               \
	((n) << 0) /**< Channel interrupt mask \
									value.                     */
/** @} */
...
#define HCINT_ACK                     \
	(1U << 5) /**< ACK response         \
								 ...
								 interrupt.                 */
#define HCINT_NAK                      \
	(1U << 4) /**< NAK response received \
								 interrupt.                 */
#define HCINT_STALL                                       \
	(1U << 3)									 /**< STALL response received \
																	interrupt.                 */
...
#define HCINTMSK_NYET                   \
	(1U << 6) /**< NYET response received \
								 interrupt mask.            */
#define HCINTMSK_ACKM                 \
	(1U << 5) /**< ACK Response         \
								 received/transmitted \
								 interrupt mask.            */
#define HCINTMSK_NAKM                  \
	(1U << 4) /**< NAK response received \
								 interrupt mask.            */
#define HCINTMSK_STALLM                                       \
	(1U << 3)											 /**< STALL response received \
																			interrupt mask.            */
 ...
 * @{
 */
#define DCFG_PFIVL_MASK                   \
	(3U << 11) /**< Periodic frame interval \
									mask.                      */
#define DCFG_PFIVL(n)                                           \
	((n) << 11)											 /**< Periodic frame interval \
																				value.                     */
#define DCFG_DAD_MASK (0x7FU << 4) /**< Device address mask.       */
#define DCFG_DAD(n) ((n) << 4)		 /**< Device address value.      */
#define DCFG_NZLSOHSK                                        \
	(1U << 2)											 /**< Non-Zero-Length status \
																			OUT handshake.             */
#define DCFG_DSPD_MASK (3U << 0) /**< Device speed mask.         */
#define DCFG_DSPD_HS (0U << 0)	 /**< High speed (USB 2.0).      */
#define DCFG_DSPD_HS_FS                     \
	(1U << 0) /**< High speed (USB 2.0) in FS \
								 mode.                      */
#define DCFG_DSPD_FS11                   \
	(3U << 0) /**< Full speed (USB 1.1     \
...
#define DCTL_CGINAK                        \
	(1U << 8) /**< Clear global non-periodic \
								 IN NAK.                    */
#define DCTL_SGINAK                                                      \
	(1U << 7)																	/**< Set global non-periodic \
																								 IN NAK.                    */
 ...
 * @{
 */
#define DSTS_FNSOF_MASK                           \
	(0x3FFU << 8) /**< Frame number of the received \
										 SOF mask.                  */
#define DSTS_FNSOF(n)                                                 \
	((n) << 8)												/**< Frame number of the received \
																				 SOF value.                 */
#define DSTS_EERR (1U << 3)					/**< Erratic error.             */
#define DSTS_ENUMSPD_MASK (3U << 1) /**< Enumerated speed mask.     */
#define DSTS_ENUMSPD_FS_48                                   \
	(3U << 1)										 /**< Full speed (PHY clock is \
																		running at 48 MHz).        */
...
#define DIEPMSK_INEPNEM                    \
	(1U << 6) /**< IN endpoint NAK effective \
								 mask.                      */
#define DIEPMSK_ITTXFEMSK                                  \
	(1U << 4)										 /**< IN token received when \
																		TxFIFO empty mask.         */
#define DIEPMSK_TOCM (1U << 3) /**< Timeout condition mask.    */
#define DIEPMSK_EPDM               \
	(1U << 1) /**< Endpoint disabled \
								 interrupt mask.            */
#define DIEPMSK_XFRCM               \
	(1U << 0) /**< Transfer completed \
								 interrupt mask.            */
/** @} */
 ...
 * @{
 */
#define DOEPMSK_OTEPDM                                       \
	(1U << 4)											/**< OUT token received when \
																		 endpoint disabled mask.    */
#define DOEPMSK_STUPM (1U << 3) /**< SETUP phase done mask.     */
#define DOEPMSK_EPDM               \
	(1U << 1) /**< Endpoint disabled \
								 interrupt mask.            */
#define DOEPMSK_XFRCM               \
	(1U << 0) /**< Transfer completed \
								 interrupt mask.            */
/** @} */
 ...
 * @{
 */
#define DAINT_OEPINT_MASK                     \
	(0xFFFFU << 16) /**< OUT endpoint interrupt \
											bits mask.                 */
#define DAINT_OEPINT(n)                   \
	((n) << 16) /**< OUT endpoint interrupt \
									 bits value.                */
#define DAINT_IEPINT_MASK                   \
	(0xFFFFU << 0) /**< IN endpoint interrupt \
											bits mask.                 */
#define DAINT_IEPINT(n)                 \
	((n) << 0) /**< IN endpoint interrupt \
									bits value.                */
/** @} */
 ...
 * @{
 */
#define DAINTMSK_OEPM_MASK                   \
	(0xFFFFU << 16) /**< OUT EP interrupt mask \
											bits mask.                 */
#define DAINTMSK_OEPM(n)                        \
	(1U << (16 + (n))) /**< OUT EP interrupt mask \
												bits value.                */
#define DAINTMSK_IEPM_MASK                 \
	(0xFFFFU << 0) /**< IN EP interrupt mask \
											bits mask.                 */
#define DAINTMSK_IEPM(n)                \
	(1U << (n)) /**< IN EP interrupt mask \
									 bits value.                */
/** @} */
 ...
 * @{
 */
#define DVBUSDIS_VBUSDT_MASK                \
	(0xFFFFU << 0) /**< Device VBUS discharge \
											time mask.                 */
#define DVBUSDIS_VBUSDT(n)              \
	((n) << 0) /**< Device VBUS discharge \
									time value.                */
/** @} */
 ...
 * @{
 */
#define DVBUSPULSE_DVBUSP_MASK               \
	(0xFFFU << 0) /**< Device VBUSpulsing time \
										 mask.                      */
#define DVBUSPULSE_DVBUSP(n)               \
	((n) << 0) /**< Device VBUS pulsing time \
									value.                     */
/** @} */
 ...
 * @{
 */
#define DIEPEMPMSK_INEPTXFEM(n)        \
	(1U << (n)) /**< IN EP Tx FIFO empty \
									 interrupt mask bit.        */
/** @} */
...
#define DIEPINT_ITTXFE                                    \
	(1U << 4)										/**< IN Token received when \
																	 TxFIFO is empty.           */
#define DIEPINT_TOC (1U << 3) /**< Timeout condition.         */
#define DIEPINT_EPDISD                                \
	(1U << 1)										 /**< Endpoint disabled \
																		interrupt.                 */
 ...
 * @{
 */
#define DTXFSTS_INEPTFSAV_MASK                \
	(0xFFFF << 0) /**< IN endpoint TxFIFO space \
										 available.                 */
/** @} */
 ...
 * @{
 */
#define DOEPINT_B2BSTUP                     \
	(1U << 6) /**< Back-to-back SETUP packets \
								 received.                  */
#define DOEPINT_OTEPDIS                                     \
	(1U << 4)										 /**< OUT token received when \
																		endpoint disabled.         */
#define DOEPINT_STUP (1U << 3) /**< SETUP phase done.          */
#define DOEPINT_EPDISD             \
	(1U << 1) /**< Endpoint disabled \
								 interrupt.                 */
#define DOEPINT_XFRC                \
	(1U << 0) /**< Transfer completed \
