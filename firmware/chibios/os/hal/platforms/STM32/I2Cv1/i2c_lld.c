...
#define I2C1_RX_DMA_CHANNEL \
	STM32_DMA_GETCHANNEL(STM32_I2C_I2C1_RX_DMA_STREAM, STM32_I2C1_RX_DMA_CHN)

#define I2C1_TX_DMA_CHANNEL \
	STM32_DMA_GETCHANNEL(STM32_I2C_I2C1_TX_DMA_STREAM, STM32_I2C1_TX_DMA_CHN)

#define I2C2_RX_DMA_CHANNEL \
	STM32_DMA_GETCHANNEL(STM32_I2C_I2C2_RX_DMA_STREAM, STM32_I2C2_RX_DMA_CHN)

#define I2C2_TX_DMA_CHANNEL \
	STM32_DMA_GETCHANNEL(STM32_I2C_I2C2_TX_DMA_STREAM, STM32_I2C2_TX_DMA_CHN)

#define I2C3_RX_DMA_CHANNEL \
	STM32_DMA_GETCHANNEL(STM32_I2C_I2C3_RX_DMA_STREAM, STM32_I2C3_RX_DMA_CHN)

#define I2C3_TX_DMA_CHANNEL \
	STM32_DMA_GETCHANNEL(STM32_I2C_I2C3_TX_DMA_STREAM, STM32_I2C3_TX_DMA_CHN)
...
static void i2c_lld_set_clock(I2CDriver* i2cp) {
	...
	if (clock_speed <= 100000) {
		...
		chDbgAssert(duty == STD_DUTY_CYCLE, "i2c_lld_set_clock(), #1",
		...
		chDbgAssert(clock_div >= 0x04, "i2c_lld_set_clock(), #3",
		...
		chDbgAssert((duty == FAST_DUTY_CYCLE_2) || (duty == FAST_DUTY_CYCLE_16_9),
								"i2c_lld_set_clock(), #4", "Invalid fast mode duty cycle");
		...
		chDbgAssert(clock_div >= 0x01, "i2c_lld_set_clock(), #7",
								"Clock divider less then 0x04 not allowed");
	...
	chDbgAssert((clock_div <= I2C_CCR_CCR), "i2c_lld_set_clock(), #8",
							"the selected clock is too low");
...
void i2c_lld_start(I2CDriver* i2cp) {
	...
	i2cp->txdmamode = STM32_DMA_CR_PSIZE_BYTE | STM32_DMA_CR_MSIZE_BYTE |
										...
										STM32_DMA_CR_TCIE | STM32_DMA_CR_DIR_M2P;
	i2cp->rxdmamode = STM32_DMA_CR_PSIZE_BYTE | STM32_DMA_CR_MSIZE_BYTE |
										STM32_DMA_CR_MINC | STM32_DMA_CR_DMEIE | STM32_DMA_CR_TEIE |
										STM32_DMA_CR_TCIE | STM32_DMA_CR_DIR_P2M;
	...
	if (i2cp->state == I2C_STOP) {
		...
		if (&I2CD1 == i2cp) {
			...
			rccResetI2C1();
			b = dmaStreamAllocate(i2cp->dmarx, STM32_I2C_I2C1_IRQ_PRIORITY,
		...
		if (&I2CD2 == i2cp) {
			...
			rccResetI2C2();
			b = dmaStreamAllocate(i2cp->dmarx, STM32_I2C_I2C2_IRQ_PRIORITY,
														(stm32_dmaisr_t)i2c_lld_serve_rx_end_irq,
														(void*)i2cp);
		...
		if (&I2CD3 == i2cp) {
			...
			rccResetI2C3();
			b = dmaStreamAllocate(i2cp->dmarx, STM32_I2C_I2C3_IRQ_PRIORITY,
														(stm32_dmaisr_t)i2c_lld_serve_rx_end_irq,
														(void*)i2cp);
