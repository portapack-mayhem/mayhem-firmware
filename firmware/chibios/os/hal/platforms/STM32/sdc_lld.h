 ...
 */
#define STM32_SDIO_ICR_ALL_FLAGS                                  \
	(SDIO_ICR_CCRCFAILC | SDIO_ICR_DCRCFAILC | SDIO_ICR_CTIMEOUTC | \
	 SDIO_ICR_DTIMEOUTC | SDIO_ICR_TXUNDERRC | SDIO_ICR_RXOVERRC |  \
	 SDIO_ICR_CMDRENDC | SDIO_ICR_CMDSENTC | SDIO_ICR_DATAENDC |    \
	 SDIO_ICR_STBITERRC | SDIO_ICR_DBCKENDC | SDIO_ICR_SDIOITC |    \
	 SDIO_ICR_CEATAENDC)

/**
 * @brief Mask of error flags in STA register.
 */
#define STM32_SDIO_STA_ERROR_MASK                              \
 ...
 */
typedef enum { SDC_MODE_1BIT = 0, SDC_MODE_4BIT, SDC_MODE_8BIT } sdcbusmode_t;
