...
#define PCUSB (1 << 31)
#define PCALL                                                               \
	(PCTIM0 | PCTIM1 | PCUART0 | PCUART1 | PCPWM0 | PCI2C0 | PCSPI0 | PCRTC | \
	 PCSPI1 | PCAD0 | PCI2C1 | PCAD1 | PCUSB)
...
#define ALLINTMASK                                                             \
	(INTMASK(SOURCE_WDT) | INTMASK(SOURCE_ARMCore0) | INTMASK(SOURCE_ARMCore1) | \
	 INTMASK(SOURCE_Timer0) | INTMASK(SOURCE_Timer1) | INTMASK(SOURCE_UART0) |   \
	 INTMASK(SOURCE_UART1) | INTMASK(SOURCE_PWM0) | INTMASK(SOURCE_I2C0) |       \
	 INTMASK(SOURCE_SPI0) | INTMASK(SOURCE_SPI1) | INTMASK(SOURCE_PLL) |         \
	 INTMASK(SOURCE_RTC) | INTMASK(SOURCE_EINT0) | INTMASK(SOURCE_EINT1) |       \
	 INTMASK(SOURCE_EINT2) | INTMASK(SOURCE_EINT3) | INTMASK(SOURCE_ADC0) |      \
	 INTMASK(SOURCE_I2C1) | INTMASK(SOURCE_BOD) | INTMASK(SOURCE_ADC1) |         \
	 INTMASK(SOURCE_USB))
