...
#define STM32_RTC_HSE                       \
	(3 << 8) /**< HSE divided by programmable \
...
#define STM32_ADC1_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 0) | STM32_DMA_STREAM_ID_MSK(2, 4))
#define STM32_ADC1_DMA_CHN 0x00000000

#define STM32_HAS_ADC2 TRUE
#define STM32_ADC2_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 2) | STM32_DMA_STREAM_ID_MSK(2, 3))
#define STM32_ADC2_DMA_CHN 0x00001100

#define STM32_HAS_ADC3 TRUE
#define STM32_ADC3_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 0) | STM32_DMA_STREAM_ID_MSK(2, 1))
...
#define STM32_I2C1_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(1, 0) | STM32_DMA_STREAM_ID_MSK(1, 5))
#define STM32_I2C1_RX_DMA_CHN 0x00100001
#define STM32_I2C1_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(1, 7) | STM32_DMA_STREAM_ID_MSK(1, 6))
#define STM32_I2C1_TX_DMA_CHN 0x11000000

#define STM32_HAS_I2C2 TRUE
#define STM32_I2C2_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(1, 2) | STM32_DMA_STREAM_ID_MSK(1, 3))
...
#define STM32_SDC_SDIO_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 3) | STM32_DMA_STREAM_ID_MSK(2, 6))
#define STM32_SDC_SDIO_DMA_CHN 0x04004000

/* SPI attributes.*/
#define STM32_HAS_SPI1 TRUE
#define STM32_SPI1_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 0) | STM32_DMA_STREAM_ID_MSK(2, 2))
#define STM32_SPI1_RX_DMA_CHN 0x00000303
#define STM32_SPI1_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 3) | STM32_DMA_STREAM_ID_MSK(2, 5))
...
#define STM32_SPI3_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(1, 0) | STM32_DMA_STREAM_ID_MSK(1, 2))
#define STM32_SPI3_RX_DMA_CHN 0x00000000
#define STM32_SPI3_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(1, 5) | STM32_DMA_STREAM_ID_MSK(1, 7))
#define STM32_SPI3_TX_DMA_CHN 0x00000000

#if defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx)
#define STM32_HAS_SPI4 TRUE
#define STM32_SPI4_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 0) | STM32_DMA_STREAM_ID_MSK(2, 3))
#define STM32_SPI4_RX_DMA_CHN 0x00005004
#define STM32_SPI4_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 1) | STM32_DMA_STREAM_ID_MSK(2, 4))
...
#define STM32_SPI5_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 3) | STM32_DMA_STREAM_ID_MSK(2, 5))
#define STM32_SPI5_RX_DMA_CHN 0x00702000
#define STM32_SPI5_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 4) | STM32_DMA_STREAM_ID_MSK(2, 6))
...
#define STM32_USART1_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 2) | STM32_DMA_STREAM_ID_MSK(2, 5))
...
#define STM32_USART3_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(1, 3) | STM32_DMA_STREAM_ID_MSK(1, 4))
...
#define STM32_USART6_RX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 1) | STM32_DMA_STREAM_ID_MSK(2, 2))
#define STM32_USART6_RX_DMA_CHN 0x00000550
#define STM32_USART6_TX_DMA_MSK \
	(STM32_DMA_STREAM_ID_MSK(2, 6) | STM32_DMA_STREAM_ID_MSK(2, 7))
...
#if (STM32_I2SSRC == STM32_I2SSRC_PLLI2S) && (STM32_PLLSRC == STM32_PLLSRC_HSI)
...
#error \
		"STM32_HSECLK outside acceptable range (STM32_HSECLK_MIN...STM32_HSECLK_MAX)"
#endif
...
#if (STM32_I2SSRC == STM32_I2SSRC_PLLI2S) && (STM32_PLLSRC == STM32_PLLSRC_HSE)
...
#error \
		"STM32_LSECLK outside acceptable range (STM32_LSECLK_MIN...STM32_LSECLK_MAX)"
#endif
...
#error \
		"STM32_PLLCLKIN outside acceptable range (STM32_PLLIN_MIN...STM32_PLLIN_MAX)"
#endif

/*
 * PLL enable check.
 */
#if STM32_CLOCK48_REQUIRED || (STM32_SW == STM32_SW_PLL) || \
		(STM32_MCO1SEL == STM32_MCO1SEL_PLL) ||                 \
		(STM32_MCO2SEL == STM32_MCO2SEL_PLL) || defined(__DOXYGEN__)
/**
...
#error \
		"STM32_PLLVCO outside acceptable range (STM32_PLLVCO_MIN...STM32_PLLVCO_MAX)"
#endif
...
#error \
		"STM32_PLLCLKOUT outside acceptable range (STM32_PLLOUT_MIN...STM32_PLLOUT_MAX)"
#endif
...
#if defined(STM32F429_439xx) || defined(STM32F427_437xx) || defined(__DOXYGEN__)
 ...
 */
#if (STM32_PLLI2SVCO < STM32_PLLVCO_MIN) || (STM32_PLLI2SVCO > STM32_PLLVCO_MAX)
#error \
		"STM32_PLLI2SVCO outside acceptable range (STM32_PLLVCO_MIN...STM32_PLLVCO_MAX)"
#endif
