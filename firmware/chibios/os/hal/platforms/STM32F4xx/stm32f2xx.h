...
#if !defined(STM32F2XX)
#error \
		"Please select first the target STM32F2XX device used in your application (in stm32f2xx.h file)"
#endif
...
#define __STM32F2XX_STDPERIPH_VERSION           \
	((__STM32F2XX_STDPERIPH_VERSION_MAIN << 24) | \
...
/**
 * @brief STM32F2XX Interrupt Number Definition, according to the selected
...
/*#define SYSCFG_PMC_MII_RMII            ((uint16_t)0x0080)*/ /*!<Ethernet PHY
																																 interface
																																 selection */
...
#define ETH_MMCCR_MCFHP                                                      \
	((uint32_t)0x00000020) /* MMC counter Full-Half preset (Only in STM32F2xx) \
													*/
#define ETH_MMCCR_MCP \
	((uint32_t)0x00000010) /* MMC counter preset (Only in STM32F2xx) */
