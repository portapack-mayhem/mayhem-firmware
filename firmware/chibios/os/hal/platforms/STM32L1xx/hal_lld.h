...
#define PVD_IRQHandler                \
	Vector44 /**< PVD through EXTI Line \
								detect.                    */
#define TAMPER_STAMP_IRQHandler       \
	Vector48 /**< Tamper and Time Stamp \
								through EXTI.              */
#define RTC_WKUP_IRQHandler                                           \
	Vector4C															/**< RTC Wakeup Timer through \
																						 EXTI.                      */
...
#if STM32_ADC_CLOCK_ENABLED || (STM32_SW == STM32_SW_HSI) ||              \
		((STM32_SW == STM32_SW_PLL) && (STM32_PLLSRC == STM32_PLLSRC_HSI)) || \
		(STM32_MCOSEL == STM32_MCOSEL_HSI) ||                                 \
		((STM32_MCOSEL == STM32_MCOSEL_PLL) && (STM32_PLLSRC == STM32_PLLSRC_HSI))
...
/* PLL related checks.*/
#if STM32_USB_CLOCK_ENABLED || (STM32_SW == STM32_SW_PLL) || \
		(STM32_MCOSEL == STM32_MCOSEL_PLL) || defined(__DOXYGEN__)
/**
