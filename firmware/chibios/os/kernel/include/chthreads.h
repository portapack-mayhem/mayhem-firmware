...
#define THD_STATE_WTCOND               \
	5 /**< @brief Waiting on a condition \
				 variable.                          */
#define THD_STATE_SLEEPING                                          \
	6													 /**< @brief Waiting in @p chThdSleep() \
...
#define THD_STATE_SNDMSG                                         \
	11												 /**< @brief Sent a message, waiting \
																	answer.                            */
...
#define THD_MEM_MODE_HEAP               \
	1 /**< @brief Thread allocated from a \
				 Memory Heap.                       */
#define THD_MEM_MODE_MEMPOOL                                \
	2											/**< @brief Thread allocated from a \
														 Memory Pool.                       */
