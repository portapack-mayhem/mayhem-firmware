 ...
 * GPT2 configuration.
 */
static const GPTConfig gpt2cfg = {1000000, /* 1MHz timer clock.*/
 ...
 * GPT3 configuration.
 */
static const GPTConfig gpt3cfg = {1000000, /* 1MHz timer clock.*/
...
int main(void) {
	 ...
	 */
	chThdCreateStatic(waWorkerThread, sizeof waWorkerThread, NORMALPRIO - 20,
										WorkerThread, NULL);
	chThdCreateStatic(waPeriodicThread, sizeof waPeriodicThread, NORMALPRIO - 10,
										PeriodicThread, NULL);
