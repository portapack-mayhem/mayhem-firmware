...
static const ADCConversionGroup adcgrpcfg1 = {
		...
		{								 /* SMPR[2]  */
		 0, 0},
		{/* SQR[4]   */
		 ADC_SQR1_SQ1_N(ADC_CHANNEL_IN7) | ADC_SQR1_SQ2_N(ADC_CHANNEL_IN8), 0, 0,
		 0},
		{/* SSMPR[2] */
		 0, 0},
		{/* SSQR[4]  */
		 ADC_SQR1_SQ1_N(ADC_CHANNEL_IN8) | ADC_SQR1_SQ2_N(ADC_CHANNEL_IN7), 0, 0,
		 0}};
...
int main(void) {
	 ...
	 */
	palSetGroupMode(GPIOC, PAL_PORT_BIT(1) | PAL_PORT_BIT(2), 0,
