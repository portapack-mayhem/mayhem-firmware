...
class SubGhzDProtos : public FProtoListGeneral {
   public:
    SubGhzDProtos(const SubGhzDProtos&) = delete;             // won't use, but makes compiler happy
    SubGhzDProtos& operator=(const SubGhzDProtos&) = delete;  // won't use, but makes compiler happy
    SubGhzDProtos() {
        // add protos
