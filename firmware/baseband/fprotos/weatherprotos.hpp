...
class WeatherProtos : public FProtoListGeneral {
   public:
    WeatherProtos(const WeatherProtos&) = delete;             // won't use, but makes compiler happy
    WeatherProtos& operator=(const WeatherProtos&) = delete;  // won't use, but makes compiler happy
    WeatherProtos() {
        // add protos
