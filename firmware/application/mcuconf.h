...
#define PORTAPACK_FAST_SDIO TRUE  // Activating in the SD card the old "High Speed version 1.10" Doubling SD clock 25Mhz->50Mhz.
                                  // Bus Interface speed from 12,5MB/s (version 1.01) to 25MB/s (version 1.10)