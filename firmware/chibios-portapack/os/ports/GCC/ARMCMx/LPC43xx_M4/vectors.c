...
vectors_t _vectors = {
		...
		{Vector40,	Vector44,	 Vector48,	Vector4C, Vector50, Vector54, Vector58,
		 ...
		 VectorB0,	VectorB4,	 VectorB8,	VectorBC, VectorC0, VectorC4, VectorC8,
		 VectorCC,	VectorD0,	 VectorD4,	VectorD8, VectorDC, VectorE0, VectorE4,
		 VectorE8,	VectorEC,	 VectorF0,	VectorF4, VectorF8, VectorFC, Vector100,
		 Vector104, Vector108, Vector10C, Vector110}};
