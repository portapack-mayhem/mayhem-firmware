...
#define __NVIC_PRIO_BITS \
	2 /*!< LPC43XX M0 uses 2 Bits for the Priority Levels */
#define __Vendor_SysTickConfig \
	0 /*!< Set to 1 if different SysTick Config is used   */

/**
 * @brief LPC43XX M0 Interrupt Number Definition, according to the selected
...
typedef enum IRQn {
	...
	RTC_IRQn = 0, /*!< 16 RTC */
	M4CORE_IRQn =
			1,				/*!< 17 Cortex-M4; Latched TXEV; for M0APP-M4 communication				*/
	DMA_IRQn = 2, /*!< 18 DMA */
	/* 3: 19 Reserved */
	...
	USART2_OR_C_CAN1_IRQn =
			26,						/*!< 42 USART2 interrupt ORed with C_CAN1 interrupt					 */
