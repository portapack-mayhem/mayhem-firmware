...
#define __NVIC_PRIO_BITS 3 /*!< LPC43XX M4 uses 3 Bits for the Priority \
															Levels*/
...
/**
 * @brief LPC43XX M4 Interrupt Number Definition, according to the selected
...
typedef enum IRQn {
	...
	DAC_IRQn = 0, /*!< 16 DAC */
	M0CORE_IRQn =
			1, /*!< 17 Cortex-M0APP; Latched TXEV; for M4-M0APP communication */
	DMA_IRQn = 2, /*!< 18 DMA */
	/* 3: 19 Reserved */
 ...
 */
__attribute__((always_inline)) __STATIC_INLINE int32_t __SXTB16(uint32_t rm,
																																uint32_t ror) {
	int32_t rd;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SXTH(uint32_t rm,
																															uint32_t ror) {
	int32_t rd;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMLATB(uint32_t rm,
																																uint32_t rs,
																																uint32_t rn) {
	int32_t rd;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMLABB(uint32_t rm,
																																uint32_t rs,
																																uint32_t rn) {
	int32_t rd;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SXTAH(uint32_t rn,
																															 uint32_t rm,
																															 uint32_t ror) {
	int32_t rd;
...
__attribute__((always_inline)) __STATIC_INLINE uint32_t __BFI(uint32_t rd,
																															uint32_t rn,
																															uint32_t lsb,
																															uint32_t width) {
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMULBB(uint32_t op1,
																																uint32_t op2) {
	int32_t result;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMULBT(uint32_t op1,
																																uint32_t op2) {
	int32_t result;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMULTB(uint32_t op1,
																																uint32_t op2) {
	int32_t result;
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMULTT(uint32_t op1,
																																uint32_t op2) {
	int32_t result;
...
__attribute__((always_inline)) static inline int64_t __SMULL(int32_t op1,
																														 int32_t op2) {
	union llreg_u {
		uint32_t w32[2];
		int64_t w64;
...
__attribute__((always_inline)) static inline int64_t __SMLALD(uint32_t op1,
																															uint32_t op2,
																															int64_t acc) {
	union llreg_u {
		uint32_t w32[2];
...
__attribute__((always_inline)) static inline int64_t __SMLALDX(uint32_t op1,
																															 uint32_t op2,
																															 int64_t acc) {
	union llreg_u {
		uint32_t w32[2];
...
__attribute__((always_inline)) static inline int64_t __SMLSLD(uint32_t op1,
																															uint32_t op2,
																															int64_t acc) {
	union llreg_u {
		uint32_t w32[2];
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMMULR(int32_t op1,
																																int32_t op2) {
	uint32_t result;
