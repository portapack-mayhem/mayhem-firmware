...
static const i2c_resources_t i2c0_resources = {
		.base = {.clk = &LPC_CGU->BASE_APB1_CLK,
						 ...
						 .stat_mask = (1 << 1)},
		.branch = {.cfg = &LPC_CCU1->CLK_APB1_I2C0_CFG,
							 .stat = &LPC_CCU1->CLK_APB1_I2C0_STAT},
...
static const i2c_resources_t i2c1_resources = {
		.base = {.clk = &LPC_CGU->BASE_APB3_CLK,
						 .stat = &LPC_CCU1->BASE_STAT,
						 .stat_mask = (1 << 0)},
		.branch = {.cfg = &LPC_CCU1->CLK_APB3_I2C1_CFG,
							 .stat = &LPC_CCU1->CLK_APB3_I2C1_STAT},
 ...
 * @notapi
 */
static void i2c_periph_set_clock(I2C_TypeDef dp,
																 uint16_t high_count,
																 uint16_t low_count) {
...
static void i2c_periph_enable(I2C_TypeDef dp) {
	dp->CONSET = I2C_CONSET_I2EN;
}

static void i2c_periph_disable(I2C_TypeDef dp) {
	dp->CONCLR =
			I2C_CONCLR_AAC | I2C_CONCLR_SIC | I2C_CONCLR_STAC | I2C_CONCLR_I2ENC;
}
/*
...
static void i2c_periph_clear_all(I2C_TypeDef dp) {
	dp->CONCLR = I2C_CONCLR_SIC | I2C_CONCLR_STAC;
}
...
#if LPC43XX_I2C_USE_I2C0 || defined(__DOXYGEN__)
	if (LPC_I2C0->CONSET & I2C_CONSET_SI)
		i2c_lld_serve_event_interrupt(&I2CD0);
#endif

#if LPC43XX_I2C_USE_I2C1 || defined(__DOXYGEN__)
	if (LPC_I2C1->CONSET & I2C_CONSET_SI)
		i2c_lld_serve_event_interrupt(&I2CD1);
#endif
...
void i2c_lld_start(I2CDriver* i2cp) {
	...
	if (&I2CD0 == i2cp) {
		nvicEnableVector(I2C0_IRQn,
										 CORTEX_PRIORITY_MASK(LPC43XX_M4_I2C_I2C0_IRQ_PRIORITY));
	}
#endif /* LPC43XX_I2C_USE_I2C0 */
	...
	if (&I2CD1 == i2cp) {
		nvicEnableVector(I2C1_IRQn,
										 CORTEX_PRIORITY_MASK(LPC43XX_M4_I2C_I2C1_IRQ_PRIORITY));
	}
#endif /* LPC43XX_I2C_USE_I2C1 */
#endif
	...
	nvicEnableVector(
			I2C0_OR_I2C1_IRQn,
			CORTEX_PRIORITY_MASK(LPC43XX_M0_I2C_I2C0_OR_I2C1_IRQ_PRIORITY));
#endif
}
...
static msg_t i2c_lld_master_start(I2CDriver* i2cp,
																	uint_fast8_t addr_r,
																	const uint8_t* txbuf,
																	size_t txbytes,
																	uint8_t* rxbuf,
	...
	dp->CONCLR = I2C_CONCLR_AAC | I2C_CONCLR_SIC | I2C_CONCLR_STAC;
	dp->CONSET = I2C_CONSET_STA;
...
msg_t i2c_lld_master_transmit_timeout(I2CDriver* i2cp,
																			...
																			size_t rxbytes,
																			systime_t timeout) {
	return i2c_lld_master_start(i2cp, (addr << 1) | 0, txbuf, txbytes, rxbuf,
															rxbytes, timeout);
}
...
msg_t i2c_lld_master_receive_timeout(I2CDriver* i2cp,
																		 ...
																		 size_t rxbytes,
																		 systime_t timeout) {
	return i2c_lld_master_start(i2cp, (addr << 1) | 1, NULL, 0, rxbuf, rxbytes,
															timeout);
}
