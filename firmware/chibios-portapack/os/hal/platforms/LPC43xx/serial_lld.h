 ...
 * @brief   USART0 clock.
 */
#define LPC_SERIAL_USART0_PCLK (LPC_MAINCLK / LPC_SERIAL_USART0CLKDIV)

/**
 * @brief   UART1 clock.
 */
#define LPC_SERIAL_UART1_PCLK (LPC_MAINCLK / LPC_SERIAL_UART1CLKDIV)

/**
 * @brief   USART2 clock.
 */
#define LPC_SERIAL_USART2_PCLK (LPC_MAINCLK / LPC_SERIAL_USART2CLKDIV)

/**
 * @brief   USART3 clock.
 */
#define LPC_SERIAL_USART3_PCLK (LPC_MAINCLK / LPC_SERIAL_USART3CLKDIV)
