...
static const timer_resources_t timer0_resources = {
		.branch = {.cfg = &LPC_CCU1->CLK_M4_TIMER0_CFG,
							 .stat = &LPC_CCU1->CLK_M4_TIMER0_STAT},
		.reset = {.output_index = 32},
		.interrupt = {.irq = TIMER0_IRQn,
									.priority_mask =
											CORTEX_PRIORITY_MASK(LPC43XX_GPT_TIMER0_IRQ_PRIORITY)},
};
#endif /* LPC43XX_GPT_USE_TIMER0 */

#if LPC43XX_GPT_USE_TIMER1
static const timer_resources_t timer1_resources = {
		.branch = {.cfg = &LPC_CCU1->CLK_M4_TIMER1_CFG,
							 .stat = &LPC_CCU1->CLK_M4_TIMER1_STAT},
		.reset = {.output_index = 33},
		.interrupt = {.irq = TIMER1_IRQn,
									.priority_mask =
											CORTEX_PRIORITY_MASK(LPC43XX_GPT_TIMER1_IRQ_PRIORITY)},
};
#endif /* LPC43XX_GPT_USE_TIMER1 */

#if LPC43XX_GPT_USE_TIMER2
static const timer_resources_t timer2_resources = {
		.branch = {.cfg = &LPC_CCU1->CLK_M4_TIMER2_CFG,
							 .stat = &LPC_CCU1->CLK_M4_TIMER2_STAT},
		.reset = {.output_index = 34},
		.interrupt = {.irq = TIMER2_IRQn,
									.priority_mask =
											CORTEX_PRIORITY_MASK(LPC43XX_GPT_TIMER2_IRQ_PRIORITY)},
};
#endif /* LPC43XX_GPT_USE_TIMER3 */

#if LPC43XX_GPT_USE_TIMER3
static const timer_resources_t timer3_resources = {
		.branch = {.cfg = &LPC_CCU1->CLK_M4_TIMER3_CFG,
							 .stat = &LPC_CCU1->CLK_M4_TIMER3_STAT},
		.reset = {.output_index = 35},
		.interrupt = {.irq = TIMER3_IRQn,
									.priority_mask =
											CORTEX_PRIORITY_MASK(LPC43XX_GPT_TIMER3_IRQ_PRIORITY)},
};
#endif /* LPC43XX_GPT_USE_TIMER3 */
