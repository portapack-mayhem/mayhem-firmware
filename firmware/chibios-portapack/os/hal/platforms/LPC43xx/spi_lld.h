...
#if !defined(LPC43XX) && \
		((LPC_SPI_SSP0CLKDIV < 1) || (LPC_SPI_SSP0CLKDIV > 255))
#error "invalid LPC_SPI_SSP0CLKDIV setting"
#endif

#if !defined(LPC43XX) && \
		((LPC_SPI_SSP1CLKDIV < 1) || (LPC_SPI_SSP1CLKDIV > 255))
 ...
 * @brief   SSP0 clock.
 */
#define LPC_SPI_SSP0_PCLK (LPC43XX_MAINCLK / LPC_SPI_SSP0CLKDIV)

/**
 * @brief   SSP1 clock.
 */
#define LPC_SPI_SSP1_PCLK (LPC43XX_MAINCLK / LPC_SPI_SSP1CLKDIV)
