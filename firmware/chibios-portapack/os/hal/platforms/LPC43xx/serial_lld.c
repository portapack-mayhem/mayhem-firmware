...
static const SerialConfig default_config = {
		SERIAL_DEFAULT_BITRATE, LCR_WL8 | LCR_STOP1 | LCR_NOPARITY, FCR_TRIGGER0};

#if LPC_SERIAL_USE_USART0
static const uart_resources_t usart0_resources = {
		.base = {.clk = &LPC_CGU->BASE_UART0_CLK,
						 .stat = &LPC_CCU2->BASE_STAT,
						 .stat_mask = (1 << 4)},
		.branch_register_if = {.cfg = &LPC_CCU1->CLK_M4_USART0_CFG,
													 .stat = &LPC_CCU1->CLK_M4_USART0_STAT},
		.branch_peripheral = {.cfg = &LPC_CCU2->CLK_APB0_USART0_CFG,
													.stat = &LPC_CCU2->CLK_APB0_USART0_STAT},
		.reset = {.output_index = 44},
		.interrupt = {.irq = USART0_IRQn,
									.priority_mask =
...
static const uart_resources_t uart1_resources = {
		.base = {.clk = &LPC_CGU->BASE_UART1_CLK,
						 .stat = &LPC_CCU2->BASE_STAT,
						 .stat_mask = (1 << 3)},
		.branch_register_if = {.cfg = &LPC_CCU1->CLK_M4_UART1_CFG,
													 .stat = &LPC_CCU1->CLK_M4_UART1_STAT},
		.branch_peripheral = {.cfg = &LPC_CCU2->CLK_APB0_UART1_CFG,
													.stat = &LPC_CCU2->CLK_APB0_UART1_STAT},
		.reset = {.output_index = 45},
		.interrupt = {.irq = UART1_IRQn,
									.priority_mask =
...
static const uart_resources_t usart2_resources = {
		.base = {.clk = &LPC_CGU->BASE_UART2_CLK,
						 .stat = &LPC_CCU2->BASE_STAT,
						 .stat_mask = (1 << 2)},
		.branch_register_if = {.cfg = &LPC_CCU1->CLK_M4_USART2_CFG,
													 .stat = &LPC_CCU1->CLK_M4_USART2_STAT},
		.branch_peripheral = {.cfg = &LPC_CCU2->CLK_APB2_USART2_CFG,
													.stat = &LPC_CCU2->CLK_APB2_USART2_STAT},
		.reset = {.output_index = 46},
#if defined(LPC43XX_M4)
		.interrupt = {.irq = USART2_IRQn,
									.priority_mask =
											CORTEX_PRIORITY_MASK(LPC_SERIAL_USART2_IRQ_PRIORITY)},
#endif
#if defined(LPC43XX_M0)
		.interrupt = {.irq = USART2_OR_C_CAN1_IRQn,
									.priority_mask =
											CORTEX_PRIORITY_MASK(LPC_SERIAL_USART2_IRQ_PRIORITY)},
#endif
};
...
static const uart_resources_t usart3_resources = {
		.base = {.clk = &LPC_CGU->BASE_UART3_CLK,
						 .stat = &LPC_CCU2->BASE_STAT,
						 .stat_mask = (1 << 1)},
		.branch_register_if = {.cfg = &LPC_CCU1->CLK_M4_USART3_CFG,
													 .stat = &LPC_CCU1->CLK_M4_USART3_STAT},
		.branch_peripheral = {.cfg = &LPC_CCU2->CLK_APB2_USART3_CFG,
													.stat = &LPC_CCU2->CLK_APB2_USART3_STAT},
		.reset = {.output_index = 47},
		.interrupt = {.irq = USART3_IRQn,
									.priority_mask =
