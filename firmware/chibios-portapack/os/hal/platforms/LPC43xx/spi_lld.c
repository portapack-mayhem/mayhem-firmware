...
static const ssp_resources_t ssp0_resources = {
		.base = {.clk = &LPC_CGU->BASE_SSP0_CLK,
						 .stat = &LPC_CCU2->BASE_STAT,
						 .stat_mask = (1U << 6)},
		.branch_register_if = {.cfg = &LPC_CCU1->CLK_M4_SSP0_CFG,
													 .stat = &LPC_CCU1->CLK_M4_SSP0_STAT},
		.branch_peripheral = {.cfg = &LPC_CCU2->CLK_APB0_SSP0_CFG,
													.stat = &LPC_CCU2->CLK_APB0_SSP0_STAT},
...
static const ssp_resources_t ssp1_resources = {
		.base = {.clk = &LPC_CGU->BASE_SSP1_CLK,
						 .stat = &LPC_CCU2->BASE_STAT,
						 .stat_mask = (1U << 5)},
		.branch_register_if = {.cfg = &LPC_CCU1->CLK_M4_SSP1_CFG,
													 .stat = &LPC_CCU1->CLK_M4_SSP1_STAT},
		.branch_peripheral = {.cfg = &LPC_CCU2->CLK_APB2_SSP1_CFG,
													.stat = &LPC_CCU2->CLK_APB2_SSP1_STAT},
