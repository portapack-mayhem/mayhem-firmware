 ...
 * It is not necessary to externally terminate JTAG pins with internal
 * termination; they can be left floating. External pull-ups on pins with
 * internal termination is allowed, but not necessary. External pull-down
 * termination is not recommended as it would conflict with the internal
 * pull-ups
 *
 ...
 * 1V8 supply:
 * Ramps up in about 1ms.
 * EN1V8 has a 10K pull-down on the HackRF and is pulled up (very gently) by the
 * LPC43xx bootloader at boot time. So until the EN1V8 pin is reconfigured as an
 * output, the enable pin on the 1V8 supply sits at about 0.55V, which feels
 * untidy... 1V8 supply is activated when GPIO is driven high by user code.
 */
		...
		{.P =
				 {
						 {
								 // GPIO0
								 .data = (1 << 15)		// P1_20: CS_XCVR
												 | (1 << 14)	// P2_10: AMP_BYPASS
												 | (0 << 13)	// P1_18: SGPIO12, HOST_Q_INVERT
												 | (0 << 12)	// P1_17: SGPIO11, HOST_DIRECTION
												 | (1 << 11)	// P1_4:  SSP1_MOSI
												 | (1 << 10)	// P1_3:  SSP1_MISO
												 | (0 << 9)		// P1_2:  Varies by revision, float until
																			// detection
												 | (0 << 8)		// P1_1:  Varies by revision, float until
																			// detection
												 | (0 << 7)		// P2_7:  Varies by revision, float until
																			// detection
												 | (0 << 6)		// P3_6:  SPIFI_MISO
						 ...
						 },
						 {
								 ...
								 .dir = (0 << 15)		 // P3_5:  SPIFI_SIO2
												...
												| (0 << 3)	 // P1_10: SD_DAT1
												| (0 << 2)	 // P1_9:  SD_DAT0
												| (0 << 1)	// P1_8:  PortaPack CPLD.TMS(I) (output only
																		// when needed, pull up internal to CPLD)
												| (1 << 0)	// P1_7:  !MIX_BYPASS
						 },
						 {
								 // GPIO2
								 .data = (0 << 15)		// P5_6:  TX_AMP
												 ...
												 | (0 << 11)	// P5_2:  TX_MIX_BP
												 | (0 << 10)	// P5_1:  LP
												 | (0 << 9)		// P5_0:  Varies by revision, float until
																			// detection
												 | (0 << 8)		// P6_12: LED3 (TX)
												 | (1 << 7)		// P5_7:  CS_AD
												 | (0 << 6)		// P4_6:  XCVR_EN, 10K PD
												 | (0 << 5)		// P4_5:  RXENABLE
												 | (0 << 4)		// P4_4:  Varies by revision, float until
																			// detection
						 ...
						 },
						 {
								 ...
								 .data = (1 << 15)		// P7_7:  PortaPack GPIO3_15(IO)
												 ...
												 | (1 << 7)		// P6_11: VREGMODE
												 | (0 << 6)		// P6_10: Varies by revision, float until
																			// detection
												 | (1 << 5)		// P6_9:  !TX_AMP_PWR, 10K PU
												 | (1 << 4)		// P6_5:  HackRF CPLD.TMS(I) (output only
																			// when needed, pull-up internal to CPLD
																			// when 1V8 present)
												 | (1 << 3)		// P6_4:  MIXER_SDATA
												 | (1 << 2)		// P6_3:  SGPIO4, HOST_DATA4
												 | (1 << 1)		// P6_2:  HackRF CPLD.TDI(I), PortaPack
																			// I2S0_RX_SDA(O), PortaPack CPLD.TDI(I)
																			// (output only when needed, pull-up
																			// internal to CPLD when 1V8 present)
												 |
												 (1 << 0)	 // P6_1:  HackRF CPLD.TCK(I), PortaPack
																	 // CPLD.TCK(I) (output only when needed,
																	 // pull-up internal to CPLD when 1V8 present)
								 ,
								 .dir = (0 << 15)		 // P7_7:  PortaPack GPIO3_15(IO)
												...
												| (0 << 6)	 // P6_10: Varies by revision, float until
																		 // detection
												| (1 << 5)	 // P6_9:  !TX_AMP_PWR, 10K PU
												| (0 << 4)	 // P6_5:  HackRF CPLD.TMS(I) (output only
																		 // when needed, pull-up internal to CPLD
																		 // when 1V8 present)
												| (0 << 3)	 // P6_4:  MIXER_SDATA
												| (0 << 2)	 // P6_3:  SGPIO4, HOST_DATA4
												| (0 << 1)	 // P6_2:  HackRF CPLD.TDI(I), PortaPack
																		 // I2S0_RX_SDA(O), PortaPack CPLD.TDI(I)
																		 // (output only when needed, pull-up
																		 // internal to CPLD when 1V8 present)
												|
												(0 << 0)	// P6_1:  HackRF CPLD.TCK(I), PortaPack
																	// CPLD.TCK(I) (output only when needed,
																	// pull-up internal to CPLD when 1V8 present)
						 },
						 {
						 ...
						 {
								 // GPIO5
								 .data = (1 << 18)		// P9:5:  HackRF CPLD.TDO(O) (input with
																			// pull up)
												 | (1 << 16)	// P6_8:  MIX_BYPASS
												 | (0 << 15)	// P6_7:  Varies by revision, float until
																			// detection
												 | (1 << 14)	// P4_10: SGPIO15, CPLD (unused)
												 | (1 << 13)	// P4_9:  SGPIO14, CPLD (unused)
												 | (0 << 12)	// P4_8:  Varies by revision, float until
																			// detection
												 | (1 << 11)	// P3_8:  SPIFI_CS
												 ...
												 | (0 << 7)		// P2_8:  BOOT2
												 | (0 << 6)		// P2_6:  MIXER_SCLK
												 | (0 << 5)		// P2_5:  Varies by revision, float until
																			// detection
								 ...
								 ,
								 .dir = (0 << 18)	 // P9_5:  HackRF CPLD.TDO(O) (input with pull
																	 // up)
												| (1 << 16)	 // P6_8:  MIX_BYPASS
												| (0 << 15)	 // P6_7:  Varies by revision, float until
																		 // detection
		 ...
		 .SCU = {
				 /* Configure GP_CLKIN as soon as possible. It's an output at boot time,
					* and the Si5351C doesn't reset when the reset button is pressed, so
					* it could still be output enabled.
					*/
				 {4, 7,
					scu_config_normal_drive_t{
							.mode = 1,
							.epd = 0,
							.epun = 0,
							.ehs = 0,
							.ezi = 1,
							.zif = 1}}, /* GP_CLKIN/P72/MCU_CLK: SI5351C.CLK7(O) */

				 /* HackRF: LEDs. Configured early so we can use them to indicate boot
						status. */
				 {4, 1,
					scu_config_normal_drive_t{.mode = 0,
																		.epd = 0,
																		.epun = 1,
																		.ehs = 0,
																		.ezi = 0,
				 ...
				 {6, 11,
					scu_config_normal_drive_t{
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* VREGMODE/P69: TPS62410.MODE/DATA(I) */
				 ...
				 {1, 3,
					scu_config_normal_drive_t{
							...
							.ehs = 0,
							.ezi = 1,
							.zif = 0}}, /* SSP1_MISO/P41: MAX2837.DOUT(O) */
				 {1, 4,
					scu_config_normal_drive_t{
							.mode = 5,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* SSP1_MOSI/P40: MAX2837.DIN(I), MAX5864.DIN(I) */
				 {1, 7,
					scu_config_normal_drive_t{.mode = 0,
																		.epd = 0,
																		.epun = 1,
																		.ehs = 0,
																		.ezi = 0,
																		.zif = 0}}, /* !MIX_BYPASS/P35: U1.VCTL1(I),
																									 U11.VCTL2(I), U9.V2(I) */
				 {1, 19,
					scu_config_normal_drive_t{
							.mode = 1,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* SSP1_SCK/P39: MAX2837.SCLK(I), MAX5864.SCLK(I) */
				 {1, 20,
					scu_config_normal_drive_t{.mode = 0,
																		.epd = 0,
																		.epun = 1,
																		.ehs = 0,
																		.ezi = 0,
																		.zif = 0}}, /* CS_XCVR/P53: MAX2837.CS(I) */
				 {2, 6,
					scu_config_normal_drive_t{
							.mode = 4,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* MIXER_SCLK/P31: 33pF, RFFC5072.SCLK(I) */
				 {2, 10,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* AMP_BYPASS/P50: U14.V2(I), U12.V2(I) */
				 {2, 11,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* RX_AMP/P49: U12.V1(I), U14.V3(I) */
				 {2, 12,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* !RX_AMP_PWR/P52: 10K PU, Q1.G(I), power to U13 (RX
														 amp) */
				 {4, 0,
					scu_config_normal_drive_t{
							.mode = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* HP/P44: U6.VCTL1(I), U5.VCTL2(I) */
				 {4, 5,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* RXENABLE/P56: MAX2837.RXENABLE(I) */
				 {4, 6,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* XCVR_EN: 10K PD, MAX2837.ENABLE(I) */
				 {5, 1,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* LP/P45: U6.VCTL2(I), U5.VCTL1(I) */
				 {5, 2,
					scu_config_normal_drive_t{.mode = 0,
																		.epd = 0,
																		.epun = 1,
				 ...
				 {5, 4,
					scu_config_normal_drive_t{
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* MIXER_ENX/P32: 10K PU, 33pF, RFFC5072.ENX(I) */
				 {5, 5,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ezi = 0,
							.zif =
									0}}, /* MIXER_RESETX/P33: 10K PU, 33pF, RFFC5072.RESETX(I) */
				 {5, 6,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* TX_AMP/P48: U12.V3(I), U14.V1(I) */
				 {5, 7,
					scu_config_normal_drive_t{.mode = 0,
																		.epd = 0,
																		.epun = 1,
				 ...
				 {6, 4,
					scu_config_normal_drive_t{
							...
							.ehs = 0,
							.ezi = 1,
							.zif = 0}}, /* MIXER_SDATA/P27: 33pF, RFFC5072.SDATA(IO) */
				 {6, 8,
					scu_config_normal_drive_t{
							.mode = 4,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* MIX_BYPASS/P34: U1.VCTL2(I), U11.VCTL1(I) */
				 {6, 9,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* !TX_AMP_PWR/P51: 10K PU, Q2.G(I), power to U25 (TX
														 amp) */
				 ...
				 {0, 0,
					scu_config_normal_drive_t{
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO0/P75/BANK2F3M3: CPLD.89/HOST_DATA0(IO) */
				 {0, 1,
					scu_config_normal_drive_t{
							.mode = 3,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO1/BANK2F3M5: CPLD.79/HOST_DATA1(IO) */
				 {1, 15,
					scu_config_normal_drive_t{
							.mode = 2,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO2/BANK2F3M9: CPLD.74/HOST_DATA2(IO) */
				 {1, 16,
					scu_config_normal_drive_t{
							.mode = 2,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO3/BANK2F3M10: CPLD.72/HOST_DATA3(IO) */
				 {6, 3,
					scu_config_normal_drive_t{
							.mode = 2,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO4/BANK2F3M14: CPLD.67/HOST_DATA4(IO) */
				 {6, 6,
					scu_config_normal_drive_t{
							.mode = 2,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO5/BANK2F3M15: CPLD.64/HOST_DATA5(IO) */
				 {2, 2,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO6/BANK2F3M16: CPLD.61/HOST_DATA6(IO) */
				 {1, 0,
					scu_config_normal_drive_t{
							.mode = 6,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 1,
							.zif = 1}}, /* SGPIO7/P76/BANK2F3M7: CPLD.77/HOST_DATA7(IO) */
				 {9, 6,
					scu_config_normal_drive_t{
							.mode = 6,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 1,
							.zif = 1}}, /* SGPIO8/SGPIO_CLK/P60: SI5351C.CLK2(O) */
				 {4, 3,
					scu_config_normal_drive_t{
							.mode = 7,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 1,
							.zif = 1}}, /* SGPIO9/P77/BANK2F3M1: CPLD.91/HOST_CAPTURE(O) */
				 {1, 14,
					scu_config_normal_drive_t{
							.mode = 6,
							.epd = 0,
							...
							.ehs = 1,
							.ezi = 0,
							.zif = 0}}, /* SGPIO10/P78/BANK2F3M8: CPLD.76/HOST_DISABLE(I) */
				 {1, 17,
					scu_config_normal_drive_t{
							.mode = 6,
							.epd = 1,
							...
							.ezi = 0,
							.zif =
									0}}, /* SGPIO11/P79/BANK2F3M11: CPLD.71/HOST_DIRECTION(I) */
				 {1, 18,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* SGPIO12/BANK2F3M12: CPLD.70/HOST_INVERT(I) */
				 {4, 9,
					scu_config_normal_drive_t{
							.mode = 4,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* SGPIO14/BANK2F3M4: CPLD.81/CPLD_P81 */
				 {4, 10,
					scu_config_normal_drive_t{
							.mode = 4,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* SGPIO15/BANK2F3M6: CPLD.78/CPLD_P78 */
				 ...
				 {6, 1,
					scu_config_normal_drive_t{
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* CPLD_TCK: CPLD.TCK(I), PortaPack CPLD.TCK(I) */
				 {6, 2,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 1,
							.zif = 0}}, /* CPLD_TDI: CPLD.TDI(I), PortaPack I2S0_RX_SDA(O),
														 PortaPack CPLD.TDI(I) */
				 {6, 5,
					scu_config_normal_drive_t{.mode = 0,
																		.epd = 0,
																		.epun = 1,
																		.ehs = 0,
																		.ezi = 0,
																		.zif = 0}}, /* CPLD_TMS: CPLD.TMS(I) */
				 {9, 5,
					scu_config_normal_drive_t{.mode = 4,
																		.epd = 0,
																		.epun = 0,
																		.ehs = 0,
																		.ezi = 1,
																		.zif = 0}}, /* CPLD_TDO: CPLD.TDO(O) */
				 ...
				 {1, 5,
					scu_config_normal_drive_t{
							...
							.ehs = 0,
							.ezi = 1,
							.zif = 0}}, /* SD_POW: PortaPack CPLD.TDO(O) */
				 {1, 8,
					scu_config_normal_drive_t{
							.mode = 0,
							.epd = 0,
							...
							.ehs = 0,
							.ezi = 0,
							.zif = 0}}, /* SD_VOLT0: PortaPack CPLD.TMS(I) */
				 ...
				 {6, 0,
					scu_config_normal_drive_t{.mode = 0,
																		...
																		.ehs = 0,
																		.ezi = 0,
																		.zif = 0}}, /* I2S0_RX_MCLK: Unused */
				 {15, 4,
					scu_config_normal_drive_t{.mode = 7,
																		.epd = 0,
																		.epun = 0,
																		.ehs = 0,
																		.ezi = 0,
																		.zif = 0}}, /* I2S0_RX_SCK: Unused */
...
static const std::array<scu_setup_t, 9> pins_setup_og{{
		...
		{5, 0,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* !VAA_ENABLE: 10K PU, Q3.G(I), power to VAA */
		{6, 10,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* EN1V8/P70: 10K PD, TPS62410.EN2(I), 1V8LED.A(I) */
		...
		{2, 5,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* RX/P43: U7.VCTL1(I), U10.VCTL1(I), U2.VCTL1(I) */
		{4, 4,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* TXENABLE/P55: MAX2837.TXENABLE(I) */
		{6, 7,
		 scu_config_normal_drive_t{
				 .mode = 4,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* TX/P42: U7.VCTL2(I), U10.VCTL2(I), U2.VCTL2(I) */
		...
		{4, 8,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* SGPIO13/BANK2F3M2: CPLD.90/HOST_SYNC_EN(I) */
...
static const std::array<scu_setup_t, 9> pins_setup_r9{{
		...
		{5, 0,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* EN1V8: 10K PD, TPS62410.EN2(I), 1V8LED.A(I) */
		...
		{2, 7,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* RX/ISP/P96: U7.VCTL(I), U10.VCTL(I), U2.VCTL(I) */
		{4, 4,
		 scu_config_normal_drive_t{.mode = 0,
															 .epd = 0,
															 .epun = 1,
		...
		{2, 5,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* BANK2F3M2: CPLD.90/HOST_SYNC_EN(I) */
		...
		{1, 1,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* MCU_CLK_EN/BOOT0: 10K PU, U28.1A(I) */
		{1, 2,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* CLKOUT_EN/BOOT1: 10K PD, U28.2A(I) */
		{6, 7,
		 scu_config_normal_drive_t{.mode = 4,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 0,
															 .zif = 0}}, /* CLKIN_EN: U16.SEL(I), U26.1A(I) */

		/* Miscellaneous */
		{4, 8,
		 scu_config_normal_drive_t{.mode = 1,
															 .epd = 1,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 0,
															 .zif = 0}}, /* CLKIN_DETECT: U26.2Y(O) */
}};
...
static const std::array<scu_setup_t, 26> pins_setup_portapack{{
		{2, 0,
		 scu_config_normal_drive_t{.mode = 4,
															 ...
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 0}}, /* U0_TXD: PortaPack P2_0/IO_STBX */
		{2, 1,
		 scu_config_normal_drive_t{.mode = 4,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 0}}, /* U0_RXD: PortaPack P2_1/ADDR */
		{2, 3,
		 scu_config_normal_drive_t{.mode = 4,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 0}}, /* I2C1_SDA: PortaPack P2_3/LCD_TE */
		{2, 4,
		 scu_config_normal_drive_t{
				 .mode = 4,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* I2C1_SCL: PortaPack P2_4/LCD_RDX */
		{2, 8,
		 scu_config_normal_drive_t{
				 .mode = 1,
				 .epd = 0,
				 ...
				 .ezi = 1,
				 .zif =
						 1}}, /* P2_8: 10K PD, BOOT2, DFU switch, PortaPack P2_8/<unused> */
		{2, 9,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* P2_9: 10K PD, BOOT3, PortaPack P2_9/LCD_WRX */
		{2, 13,
		 scu_config_normal_drive_t{.mode = 0,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 0}}, /* P2_13: PortaPack P2_13/DIR */
		{7, 0,
		 scu_config_normal_drive_t{.mode = 0,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 0}}, /* GPIO3_8: PortaPack GPIO3_8(IO) */
		{7, 1,
		 scu_config_normal_drive_t{.mode = 0,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 0}}, /* GPIO3_9: PortaPack GPIO3_9(IO) */
		{7, 2,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* GPIO3_10: PortaPack GPIO3_10(IO) */
		{7, 3,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* GPIO3_11: PortaPack GPIO3_11(IO) */
		{7, 4,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* GPIO3_12: PortaPack GPIO3_12(IO) */
		{7, 5,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* GPIO3_13: PortaPack GPIO3_13(IO) */
		{7, 6,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* GPIO3_14: PortaPack GPIO3_14(IO) */
		{7, 7,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* GPIO3_15: PortaPack GPIO3_15(IO) */
		...
		{3, 0,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* I2S0_TX_SCK: PortaPack I2S0_TX_SCK(I) */
		{3, 1,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 .epd = 0,
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 0}}, /* I2S0_RX_WS: PortaPack I2S0_TX_WS(I). Input enabled to
												fold back into RX. */
		{3, 2,
		 scu_config_normal_drive_t{
				 .mode = 0,
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* I2S0_RX_SDA: PortaPack I2S0_TX_SDA(I) */
		{24, 2,
		 scu_config_normal_drive_t{
				 .mode = 6,
				 .epd = 1,
				 ...
				 .ehs = 0,
				 .ezi = 0,
				 .zif = 0}}, /* I2S0_TX_CLK: PortaPack I2S0_TX_MCLK */
		...
		{24, 0,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 0,
				 .ezi = 1,
				 .zif = 1}}, /* SD_CLK: PortaPack SD.CLK, enable input buffer for timing
												feedback? */
		{1, 6,
		 scu_config_normal_drive_t{.mode = 7,
															 .epd = 0,
															 ...
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 1}}, /* SD_CMD: PortaPack SD.CMD(IO)  */
		{1, 9,
		 scu_config_normal_drive_t{.mode = 7,
															 .epd = 0,
															 .epun = 0,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 1}}, /* SD_DAT0: PortaPack SD.DAT0(IO) */
		{1, 10,
		 scu_config_normal_drive_t{.mode = 7,
															 .epd = 0,
															 .epun = 0,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 1}}, /* SD_DAT1: PortaPack SD.DAT1(IO) */
		{1, 11,
		 scu_config_normal_drive_t{.mode = 7,
															 .epd = 0,
															 .epun = 0,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 1}}, /* SD_DAT2: PortaPack SD.DAT2(IO) */
		{1, 12,
		 scu_config_normal_drive_t{.mode = 7,
															 .epd = 0,
															 .epun = 0,
															 .ehs = 0,
															 .ezi = 1,
															 .zif = 1}}, /* SD_DAT3: PortaPack SD.DAT3(IO) */
		{1, 13,
		 scu_config_normal_drive_t{.mode = 7,
															 .epd = 0,
															 .epun = 0,
...
static const std::array<scu_setup_t, 6> pins_setup_spifi{{
		{3, 3,
		 scu_config_normal_drive_t{
				 ...
				 .ehs = 1,
				 .ezi = 1,
				 .zif = 1}}, /* SPIFI_SCK: W25Q80BV.CLK(I), enable input buffer for
												timing feedback */
		{3, 4,
		 scu_config_normal_drive_t{
				 .mode = 3,
				 ...
				 .ehs = 1,
				 .ezi = 1,
				 .zif = 1}}, /* SPIFI_SIO3/P82: W25Q80BV.HOLD(IO) */
		{3, 5,
		 scu_config_normal_drive_t{.mode = 3,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 1,
															 .ezi = 1,
															 .zif = 1}}, /* SPIFI_SIO2/P81: W25Q80BV.WP(IO) */
		{3, 6,
		 scu_config_normal_drive_t{.mode = 3,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 1,
															 .ezi = 1,
															 .zif = 1}}, /* SPIFI_MISO: W25Q80BV.DO(IO) */
		{3, 7,
		 scu_config_normal_drive_t{.mode = 3,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 1,
															 .ezi = 1,
															 .zif = 1}}, /* SPIFI_MOSI: W25Q80BV.DI(IO) */
		{3, 8,
		 scu_config_normal_drive_t{.mode = 3,
															 .epd = 0,
															 .epun = 1,
															 .ehs = 1,
															 .ezi = 1,
															 .zif = 1}}, /* SPIFI_CS/P68: W25Q80BV.CS(I) */
}};
...
/*
 * HackRF One r9 has a pull-up on GPIO3_6 (P6_10) and a pull-down on GPIO2_9
 * (P5_0). HackRF One OG has a pull-down on GPIO3_6 (P6_10) and a pull-up on
 * GPIO2_9 (P5_0).
 */
static const scu_setup_t pin_setup_detect{5, 0,
																					scu_config_normal_drive_t{.mode = 0,
																																		.epd = 0,
																																		.epun = 1,
																																		.ehs = 0,
...
static void configure_spifi(void) {
	...
	LPC_SPIFI->CTRL =
			...
			| (0 << 23)		/* 0: SCK driven low after rising edge at which last bit of
											 command is captured. Stays low while CS# is high. */
	...
	LPC_CGU->IDIVB_CTRL.word = (0 << 0)		 /* PD */
														 | (2 << 2)	 /* IDIV (/3) */
														 | (1 << 11) /* AUTOBLOCK */
														 | (9 << 24) /* PLL1 */
			;
...
static const motocon_pwm_resources_t motocon_pwm_resources = {
		.base = {.clk = &LPC_CGU->BASE_APB1_CLK,
						 .stat = &LPC_CCU1->BASE_STAT,
						 .stat_mask = (1 << 1)},
		.branch = {.cfg = &LPC_CCU1->CLK_APB1_MOTOCON_PWM_CFG,
							 .stat = &LPC_CCU1->CLK_APB1_MOTOCON_PWM_STAT},
		.reset = {.output_index = 38},
};

static const scu_setup_t pin_setup_vaa_enablex_pwm = {
		5, 0,
		scu_config_normal_drive_t{.mode = 1,
															.epd = 0,
															.epun = 1,
															...
															.ezi = 0,
															.zif = 0}};
static const scu_setup_t pin_setup_vaa_enablex_gpio_og = {
		5, 0,
		scu_config_normal_drive_t{.mode = 0,
															.epd = 0,
															.epun = 1,
															...
															.ezi = 0,
															.zif = 0}};
static const scu_setup_t pin_setup_vaa_enablex_gpio_r9 = {
		6, 10,
		scu_config_normal_drive_t{.mode = 0,
															.epd = 0,
															.epun = 1,
...
void vaa_power_on(void) {
	 ...
	 *
	 * Controlling timing while running from SPIFI flash is tricky, hence use of a
	 * PWM peripheral...
	 */
	if (hackrf_r9) {
		/*
		 ...
		 */
		setup_pin(
				pin_setup_vaa_enablex_gpio_r9);	 // P6_10 GPIO3[ 6]: !VAA_ENABLE, 10K PU
		 ...
		 * Assume IDIVC is running the post-bootloader configuration, outputting
		...
		/* Combination of pulse duration and duty cycle was arrived at empirically,
		 * to keep supply glitching to +/- 0.15V.
		 */
		...
		/* Switch !VAA_ENABLE pin from GPIO to MOTOCONPWM peripheral output, now
		 * that the peripheral is configured. */
		setup_pin(pin_setup_vaa_enablex_pwm);	 // P5_0 /GPIO2[ 9]/MCOB2:
																					 // !VAA_ENABLE, 10K PU
		...
		/* Timing assumes we're running immediately after the bootloader: 96 MHz
		 * from IRC+PLL1
		 */
		...
		/* Hold !VAA_ENABLE active using a GPIO, so we can reclaim and shut down the
		 * MOTOCONPWM peripheral. */
		LPC_GPIO->CLR[2] = (1 << 9);	// !VAA_ENABLE
		LPC_GPIO->DIR[2] |= (1 << 9);
		setup_pin(pin_setup_vaa_enablex_gpio_og);	 // P5_0 /GPIO2[ 9]/MCOB2:
																							 // !VAA_ENABLE, 10K PU
...
extern "C" void __early_init(void) {
	 ...
	 * Before __early_init, LPC bootloader runs and starts our code. In user code,
	 * the process stack is initialized, hardware floating point is initialized,
	 * and stacks are zeroed,
	 */
	...
	if ((SCB->CPUID & CORTEX_M4_CPUID_MASK) == CORTEX_M4_CPUID) {
		...
		/* Don't reset these peripherals, as they're operating during
		 * initialization: WWDT, CREG, SCU, SPIFI
		 */
		LPC_RGU->RESET_CTRL[0] = (1U << 16)		 // LCD_RST
														 | (1U << 17)	 // USB0_RST
														 | (1U << 18)	 // USB1_RST
														 | (1U << 19)	 // DMA_RST
														 | (1U << 20)	 // SDIO_RST
														 ...
														 | (1U << 28)	 // GPIO_RST
				;
		LPC_RGU->RESET_CTRL[1] = (1U << 0)		 // TIMER0_RST
														 | (1U << 1)	 // TIMER1_RST
														 | (1U << 2)	 // TIMER2_RST
														 | (1U << 3)	 // TIMER3_RST
														 | (1U << 4)	 // RITIMER_RST
		...
		/* Prevent the M4 from doing any more initializing by sleep-waiting
		 * forever...
