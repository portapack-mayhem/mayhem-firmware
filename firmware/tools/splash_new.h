...
// fake transparent px should be the exact color rgb(255,0,255), then use true for the last arg when drawing bmp with the draw func

const unsigned char splash_new_t[] = {
    ...
    0x00, 0x00, 0xe6, 0x33, 0x00, 0x00, 0xe6, 0x33, 0x00, 0x00, 0xe6, 0x33,
    0x00, 0x01};
unsigned int splash_new_t_len = 3854;
