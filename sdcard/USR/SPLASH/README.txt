...
The current splash screen image is the one stored in the /USR directory of the SD card
and named "splash.bmp".  Images stored in the /USR/SPLASH AND /RES/SPLASH folders can be made the current
